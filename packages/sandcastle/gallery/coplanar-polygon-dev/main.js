...
const polygonGeometry1 = Cesium.CoplanarPolygonGeometry.fromPositions({
    ...
    positions: Cesium.Cartesian3.fromDegreesArrayHeights([
        -91.0, 40.0, 0.0, -90.0, 40.0, 200000.0, -89.0, 40.0, 200000.0, -88.0,
        40.0, 0.0,
    ]),
});
...
const polygonGeometry2 = new Cesium.CoplanarPolygonGeometry({
    ...
    polygonHierarchy: {
        positions: Cesium.Cartesian3.fromDegreesArrayHeights([
            -99.0, 38.0, 100000, -97.0, 38.0, 100000, -97.0, 40.0, 100000,
            -99.0, 40.0, 100000,
        ]),
        holes: [
            {
                positions: Cesium.Cartesian3.fromDegreesArrayHeights([
                    -98.5, 38.5, 100000, -98.5, 39.5, 100000, -97.5, 39.5,
                    100000, -97.5, 38.5, 100000,
                ]),
                holes: [
                    {
                        positions: Cesium.Cartesian3.fromDegreesArrayHeights([
                            -98.25, 38.75, 100000, -97.75, 38.75, 100000,
                            -97.75, 39.25, 100000, -98.25, 39.25, 100000,
                        ]),
                    },
                ],
            },
...
const polygonGeometry = Cesium.CoplanarPolygonGeometry.fromPositions({
    ...
    positions: Cesium.Cartesian3.fromDegreesArrayHeights([
        -95.0, 40.0, 100000.0, -94.0, 42.0, 200000.0, -93.0, 42.0, 200000.0,
        -92.0, 40.0, 100000.0,
    ]),
