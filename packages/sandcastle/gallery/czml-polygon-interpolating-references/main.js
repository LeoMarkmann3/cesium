...
const czml = [
            ...
            material: {
                solidColor: {
                    color: [
                        {
                            interval:
                                "2012-08-04T16:00:00Z/2012-08-04T16:25:00Z",
                            rgbaf: [1, 0, 1, 1],
                        },
                        {
                            interval:
    ...
    },
    {
        ...
        position: {
            ...
            cartographicDegrees: [
                0, -60, 35, 30000, 160, -65, 35, 5000000, 400, -70, 40, 20000,
                800, -62, 45, 200000, 1800, -65, 40, 650000, 3600, -60, 35,
                3000,
            ],
        },
    },
    ...
    },
    {
        ...
        position: {
            ...
            epoch: "2012-08-04T16:00:00Z",
            cartographicDegrees: [
                0, -45, 60, 4000, 400, -40, 70, 2000000, 1000, -35, 75, 100000,
                3600, -45, 65, 3000,
            ],
        },
    },
    {
        ...
        polygon: {
            positions: {
                cartographicDegrees: [
                    -110, 43, 0, -90, 43, 0, -90, 30, 0, -110, 30, 0,
                ],
            },
            holes: {
                references: [
