    ...
    function () {
        ...
        describe("tileset options", function () {
            it("show properties", async function () {
                ...
                expect(viewModel.properties.indexOf("Longitude") !== -1).toBe(
                    true,
                );
                expect(viewModel.properties.indexOf("Latitude") !== -1).toBe(
                    true,
                );
                expect(viewModel.properties.indexOf("Height") !== -1).toBe(
                    true,
                );
                viewModel.destroy();
            });
        ...
        describe("display options", function () {
            ...
            it("showContentVolumes", function () {
                ...
                expect(viewModel.tileset.debugShowContentBoundingVolume).toBe(
                    true,
                );
            ...
            it("showRequestVolumes", function () {
                ...
                expect(viewModel.tileset.debugShowViewerRequestVolume).toBe(
                    true,
                );
            ...
            it("showRenderingStatistics", function () {
                ...
                expect(viewModel.tileset.debugShowRenderingStatistics).toBe(
                    true,
                );
            ...
            it("pointCloudShading", function () {
                ...
                expect(viewModel.tileset.pointCloudShading.attenuation).toBe(
                    true,
                );
            ...
            it("geometricErrorScale", function () {
                ...
                expect(
                    viewModel.tileset.pointCloudShading.geometricErrorScale,
                ).toBe(1.0);
            ...
            it("baseResolution", function () {
                ...
                expect(viewModel.tileset.pointCloudShading.baseResolution).toBe(
                    1.0,
                );
            ...
            it("eyeDomeLighting", function () {
                ...
                expect(
                    viewModel.tileset.pointCloudShading.eyeDomeLighting,
                ).toBe(true);
            ...
            it("eyeDomeLightingRadius", function () {
                ...
                expect(
                    viewModel.tileset.pointCloudShading.eyeDomeLightingRadius,
                ).toBe(1.0);
        ...
        describe("update options", function () {
            ...
            it("dynamic screen space error", function () {
                ...
                expect(viewModel.tileset.dynamicScreenSpaceErrorDensity).toBe(
                    0.1,
                );
            });
            ...
            it("dynamicScreenSpaceErrorDensity slider uses an exponential scale", function () {
                ...
                expect(
                    viewModel.tileset.dynamicScreenSpaceErrorDensity,
                ).toEqualEpsilon(scaledValue, CesiumMath.EPSILON8);
            });
        });
        ...
        describe("style options", function () {
            ...
            it("recompiles style", function () {
                ...
                viewModel._update();
                expect(viewModel.tileset.style.style.color).toBe(
                    "color('red')",
                );
