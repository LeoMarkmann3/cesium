...
describe(
    ...
    function () {
        ...
        it("show wireframe", function () {
            ...
            expect(
                viewModel.scene.globe._surface.tileProvider._debug.wireframe,
            ).toBe(true);
        ...
        it("show tile bounding sphere", function () {
            ...
            expect(
                viewModel.scene.globe._surface.tileProvider._debug
                    .boundingSphereTile,
            ).toBe(tile);
        ...
        it("does not try to render a non-renderable tile", function () {
            ...
            viewModel.filterTile = true;
            expect(viewModel.scene.globe._surface._tilesToRender.length).toBe(
                0,
            );
            expect(viewModel.suspendUpdates).toBe(true);
