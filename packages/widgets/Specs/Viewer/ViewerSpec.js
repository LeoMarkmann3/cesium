...
describe(
    ...
    function () {
        ...
        it("constructor sets default values", function () {
            ...
            expect(viewer.navigationHelpButton).toBeInstanceOf(
                NavigationHelpButton,
            );
            ...
            expect(viewer.selectionIndicator).toBeInstanceOf(
                SelectionIndicator,
            );
            expect(viewer.imageryLayers).toBeInstanceOf(ImageryLayerCollection);
            expect(viewer.terrainProvider).toBeInstanceOf(
                EllipsoidTerrainProvider,
            );
        ...
        it("constructs geocoder with IonGeocodeProviderType", function () {
            ...
            const geocoderService =
                viewer.geocoder.viewModel._geocoderServices[0];
        ...
        it("constructs geocoder with geocoder service option", function () {
            ...
            expect(viewer.geocoder).toBeDefined();
            expect(viewer.geocoder.viewModel._geocoderServices.length).toBe(1);
            expect(viewer.geocoder.viewModel._geocoderServices[0]).toBe(
                service,
            );
        });
