...
function selectTilesetOnHover(viewModel, value) {
    if (value) {
        ...
        viewModel._eventHandler.removeInputAction(
            ScreenSpaceEventType.MOUSE_MOVE,
        );
    ...
    knockout.defineProperty(this, "picking", {
        ...
        set: function (value) {
            ...
            if (value) {
                ...
                that.feature = undefined;
                that.tile = undefined;
                that._eventHandler.removeInputAction(
                    ScreenSpaceEventType.MOUSE_MOVE,
                );
            }
        },
    ...
    knockout.defineProperty(this, "eyeDomeLightingStrength", {
        ...
        set: function (value) {
            ...
            if (!isNaN(value)) {
                ...
                if (defined(that._tileset)) {
                    that._tileset.pointCloudShading.eyeDomeLightingStrength =
                        value;
                }
            }
        },
    ...
    knockout.defineProperty(this, "eyeDomeLightingRadius", {
        ...
        set: function (value) {
            ...
            if (!isNaN(value)) {
                ...
                if (defined(that._tileset)) {
                    that._tileset.pointCloudShading.eyeDomeLightingRadius =
                        value;
                }
            }
        },
