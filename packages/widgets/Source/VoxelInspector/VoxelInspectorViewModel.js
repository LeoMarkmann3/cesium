...
function VoxelInspectorViewModel(scene) {
    ...
    function addProperty(options) {
        ...
        knockout.defineProperty(that, name, {
            ...
            set: function (value) {
                ...
                knock(value);
                if (
                    defined(setPrimitiveFunction) &&
                    defined(that._voxelPrimitive)
                ) {
    ...
    addProperty({
        ...
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMaxLatitudeMin =
                that._voxelPrimitive.minBounds.y;
        },
    });
    addProperty({
        ...
        initialValue: CesiumMath.PI_OVER_TWO,
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMaxLatitudeMax =
                that._voxelPrimitive.maxBounds.y;
        },
    });
    addProperty({
    ...
    addProperty({
        ...
        initialValue: -CesiumMath.PI_OVER_TWO,
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMinLatitudeMin =
                that._voxelPrimitive.minBounds.y;
        },
    });
    addProperty({
        ...
        initialValue: CesiumMath.PI_OVER_TWO,
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMinLatitudeMax =
                that._voxelPrimitive.maxBounds.y;
        },
    });
    addProperty({
    ...
    addProperty({
        ...
        initialValue: 0.0,
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMaxHeightMin =
                that._voxelPrimitive.minBounds.z;
        },
    });
    addProperty({
        ...
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMaxHeightMax =
                that._voxelPrimitive.maxBounds.z;
        },
    });
    addProperty({
    ...
    addProperty({
        ...
        initialValue: -100000.0,
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMinHeightMin =
                that._voxelPrimitive.minBounds.z;
        },
    });
    addProperty({
        ...
        initialValue: 0.0,
        getPrimitiveFunction: function () {
            that.clippingEllipsoidMinHeightMax =
                that._voxelPrimitive.maxBounds.z;
        },
    });
    addProperty({
    ...
    addProperty({
        ...
        initialValue: 0.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMaxRadiusMin =
                that._voxelPrimitive.minBounds.x;
        },
    });
    addProperty({
        ...
        initialValue: 1.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMaxRadiusMax =
                that._voxelPrimitive.maxBounds.x;
        },
    });
    addProperty({
    ...
    addProperty({
        ...
        initialValue: 0.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMinRadiusMin =
                that._voxelPrimitive.minBounds.x;
        },
    });
    addProperty({
        ...
        initialValue: 1.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMinRadiusMax =
                that._voxelPrimitive.maxBounds.x;
        },
    });
    addProperty({
    ...
    addProperty({
        ...
        initialValue: -1.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMaxHeightMin =
                that._voxelPrimitive.minBounds.z;
        },
    });
    addProperty({
        ...
        initialValue: 1.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMaxHeightMax =
                that._voxelPrimitive.maxBounds.z;
        },
    });
    addProperty({
    ...
    addProperty({
        ...
        initialValue: -1.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMinHeightMin =
                that._voxelPrimitive.minBounds.z;
        },
    });
    addProperty({
        ...
        initialValue: 1.0,
        getPrimitiveFunction: function () {
            that.clippingCylinderMinHeightMax =
                that._voxelPrimitive.maxBounds.z;
        },
    });
    addProperty({
        ...
        set: function (voxelPrimitive) {
            ...
            that._customShaderCompilationRemoveCallback =
                that._voxelPrimitive.customShaderCompilationEvent.addEventListener(
                    function (error) {
                        const shaderString =
                            that._voxelPrimitive.customShader
                                .fragmentShaderText;
                        that.shaderString = formatShaderString(shaderString);

                        if (!defined(error)) {
                            that.shaderCompilationMessage =
