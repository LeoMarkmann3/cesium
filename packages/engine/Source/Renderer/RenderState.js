...
function createFuncs(previousState, nextState) {
    ...
    if (
        previousState.polygonOffset.enabled !==
            nextState.polygonOffset.enabled ||
    ...
    if (
        ...
        previousState.stencilTest.reference !==
            nextState.stencilTest.reference ||
    ...
    if (
        previousState.sampleCoverage.enabled !==
            nextState.sampleCoverage.enabled ||
...
RenderState.partialApply = function (
    ...
    if (
        ...
        (blendingEnabled &&
            previousRenderState.blending !== renderState.blending)
    ) {
        applyBlending(gl, renderState, passState);
    }
...
RenderState.getState = function (renderState) {
    ...
    return {
        ...
        scissorTest: {
            ...
            rectangle: BoundingRectangle.clone(
                renderState.scissorTest.rectangle,
            ),
        },
        depthRange: {
        ...
        blending: {
            ...
            functionDestinationAlpha:
                renderState.blending.functionDestinationAlpha,
        },
        stencilTest: {
