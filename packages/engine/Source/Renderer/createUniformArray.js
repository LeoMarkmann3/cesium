...
function createUniformArray(gl, activeUniform, uniformName, locations) {
    switch (activeUniform.type) {
        ...
        case gl.SAMPLER_CUBE:
            return new UniformArraySampler(
                gl,
                activeUniform,
                uniformName,
                locations,
        ...
        case gl.INT_VEC2:
        case gl.BOOL_VEC2:
            return new UniformArrayIntVec2(
                gl,
                activeUniform,
                uniformName,
                locations,
        ...
        case gl.INT_VEC3:
        case gl.BOOL_VEC3:
            return new UniformArrayIntVec3(
                gl,
                activeUniform,
                uniformName,
                locations,
        ...
        case gl.INT_VEC4:
        case gl.BOOL_VEC4:
            return new UniformArrayIntVec4(
                gl,
                activeUniform,
                uniformName,
                locations,
