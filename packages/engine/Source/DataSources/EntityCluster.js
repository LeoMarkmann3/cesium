...
Object.defineProperties(EntityCluster.prototype, {
    ...
    pixelRange: {
        ...
        set: function (value) {
            this._clusterDirty =
                this._clusterDirty || value !== this._pixelRange;
    ...
    clusterLabels: {
        ...
        set: function (value) {
            this._clusterDirty =
                this._clusterDirty || value !== this._clusterLabels;
    ...
    clusterPoints: {
        ...
        set: function (value) {
            this._clusterDirty =
                this._clusterDirty || value !== this._clusterPoints;
...
function createGetEntity(
    ...
    return function (entity) {
        ...
        if (
            defined(collection) &&
            defined(entityIndices[entityIndexProperty])
        ) {
