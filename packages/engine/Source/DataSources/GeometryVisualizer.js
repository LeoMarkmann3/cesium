...
GeometryVisualizer.prototype._insertUpdaterIntoBatch = function (
    ...
    if (updater.outlineEnabled) {
        if (defined(updater.terrainOffsetProperty)) {
            this._outlineBatches[numberOfShadowModes + shadows].add(
                time,
                updater,
            );
        } else {
    ...
    if (updater.fillEnabled) {
        if (updater.onTerrain) {
            ...
            if (updater.fillMaterialProperty instanceof ColorMaterialProperty) {
                ...
                this._groundMaterialBatches[classificationType].add(
                    time,
                    updater,
                );
            }
            ...
            updater.fillMaterialProperty instanceof ColorMaterialProperty
        ) {
            if (defined(updater.terrainOffsetProperty)) {
