    ...
    if (!defined(geometries._verticesPromise)) {
        ...
        if (!defined(batchTableColors)) {
            ...
            if (defined(geometries._spheres)) {
                ...
                sphereBatchIds = geometries._sphereBatchIds =
                    sphereBatchIds.slice();
                length += sphereBatchIds.length;
            }

            batchTableColors = geometries._batchTableColors = new Uint32Array(
                length,
            );
        ...
        const parameters = {
            ...
            sphereBatchIds: defined(spheres)
                ? sphereBatchIds.buffer
                : undefined,
        ...
        return verticesPromise
            .then(function (result) {
                ...
                const indicesBytesPerElement = unpackBuffer(
                    geometries,
                    packedBuffer,
                );
                ...
                geometries._vertexBatchIds = new Uint16Array(
                    result.vertexBatchIds,
                );
