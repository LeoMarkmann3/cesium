...
Object.defineProperties(VoxelPrimitive.prototype, {
    ...
    levelBlendFactor: {
        ...
        set: function (levelBlendFactor) {
            ...
            this._levelBlendFactor = CesiumMath.clamp(
                levelBlendFactor,
                0.0,
                1.0,
            );
...
function initFromProvider(primitive, provider, context) {
    ...
    uniforms.pickColor = Color.clone(
        primitive._pickId.color,
        uniforms.pickColor,
    );
    ...
    primitive._traversal = new VoxelTraversal(
        primitive,
        context,
        keyframeCount,
    );
...
function orientedBoundingBoxToNdcAabb(
    ...
    result = Cartesian4.fromElements(
        ndcMinX,
        ndcMinY,
        ndcMaxX,
        ndcMaxY,
