...
function sortTileImageryByLayerIndex(a, b) {
    ...
    return (
        aImagery.imageryLayer._layerIndex - bImagery.imageryLayer._layerIndex
    );
}
...
GlobeSurfaceTileProvider.prototype.computeTileVisibility = function (
    ...
    if (defined(clippingPlanes) && clippingPlanes.enabled) {
        const planeIntersection =
            clippingPlanes.computeIntersectionWithBoundingVolume(
                boundingVolume,
            );
    ...
    while (stack.length > 0) {
        ...
        if (lastFrameSelectionResult === TileSelectionResult.RENDERED) {
            ...
            for (i = 0, len = descendantImagery.length; i < len; ++i) {
                ...
                const descendantLoadingImagery =
        ...
        while (ancestorTile !== undefined) {
            ...
            if (ancestorSurfaceTile !== undefined) {
                ...
                if (
                    ...
                    tileBoundingRegion.minimumHeight =
                        ancestorMesh.minimumHeight;
                    tileBoundingRegion.maximumHeight =
                        ancestorMesh.maximumHeight;
                    break;
                } else if (
                    ...
                    tileBoundingRegion.minimumHeight =
                        ancestorTerrainData._minimumHeight;
                    tileBoundingRegion.maximumHeight =
                        ancestorTerrainData._maximumHeight;
                    break;
                }
            }
        ...
        const reloadFunction = function () {
            ...
            that._quadtree.forEachLoadedTile(function (tile) {
                ...
                if (
                    ...
                    tile._loadedCallbacks[layer._layerIndex] =
                        getTileReadyCallback(
                            tileImageriesToFree,
                            layer,
                            terrainProvider,
                        );
...
function createTileUniformMap(frameState, globeSurfaceTileProvider) {
    const uniformMap = {
        ...
        u_clippingExtents: function () {
            const texture =
                globeSurfaceTileProvider._clippingPolygons.extentsTexture;
            if (defined(texture)) {
                return texture;
            }
            return frameState.context.defaultTexture;
        ...
        properties: {
            ...
            atmosphereRayleighCoefficient: new Cartesian3(
                5.5e-6,
                13.0e-6,
                28.4e-6,
            ),
...
function addDrawCommandsForTile(tileProvider, tile, frameState) {
    ...
    const showGroundAtmosphere =
        tileProvider.showGroundAtmosphere &&
        frameState.mode === SceneMode.SCENE3D;
    const castShadows =
    ...
    if (showGroundAtmosphere) {
        const cameraDistance = Cartesian3.magnitude(
    ...
    surfaceShaderSetOptions.clippedByBoundaries =
        surfaceTile.clippedByBoundaries;
    surfaceShaderSetOptions.hasGeodeticSurfaceNormals =
    ...
    do {
        ...
        if (
            tileProvider._drawCommands.length <= tileProvider._usedDrawCommands
        ) {
            ...
            command =
                tileProvider._drawCommands[tileProvider._usedDrawCommands];
            uniformMap =
                tileProvider._uniformMaps[tileProvider._usedDrawCommands];
        }
        ...
        if (tile === tileProvider._debug.boundingSphereTile) {
            ...
            if (defined(obb)) {
                ...
                getDebugBoundingSphere(boundingSphere, Color.RED).update(
                    frameState,
                );
            }
        }
        ...
        uniformMapProperties.nightFadeDistance.y =
            tileProvider.nightFadeInDistance;
        ...
        uniformMapProperties.lambertDiffuseMultiplier =
        ...
        uniformMapProperties.verticalExaggerationAndRelativeHeight.x =
            exaggeration;
        ...
        localizedCartographicLimitRectangle.y =
            (cartographicLimitRectangle.south -
        ...
        localizedCartographicLimitRectangle.w =
            (cartographicLimitRectangle.north -
                cartographicTileRectangle.south) *
            inverseTileHeight;
        ...
        localizedTranslucencyRectangle.x =
            (clippedTranslucencyRectangle.west -
                cartographicTileRectangle.west) *
            inverseTileWidth;
        localizedTranslucencyRectangle.y =
            (clippedTranslucencyRectangle.south -
                cartographicTileRectangle.south) *
            inverseTileHeight;
        localizedTranslucencyRectangle.z =
            (clippedTranslucencyRectangle.east -
                cartographicTileRectangle.west) *
            inverseTileWidth;
        localizedTranslucencyRectangle.w =
            (clippedTranslucencyRectangle.north -
                cartographicTileRectangle.south) *
            inverseTileHeight;
        ...
        while (numberOfDayTextures < maxTextures && imageryIndex < imageryLen) {
            ...
            if (!defined(tileImagery.textureTranslationAndScale)) {
                tileImagery.textureTranslationAndScale =
                    imageryLayer._calculateTextureTranslationAndScale(
                        tile,
                        tileImagery,
                    );
            }
            ...
            applyDayNightAlpha =
                applyDayNightAlpha ||
                uniformMapProperties.dayTextureNightAlpha[
                    numberOfDayTextures
                ] !== 1.0;
            ...
            applyBrightness =
                applyBrightness ||
                uniformMapProperties.dayTextureBrightness[
                    numberOfDayTextures
            ...
            applySaturation =
                applySaturation ||
                uniformMapProperties.dayTextureSaturation[
                    numberOfDayTextures
            ...
            applyGamma =
                applyGamma ||
                uniformMapProperties.dayTextureOneOverGamma[
                    numberOfDayTextures
                ] !==
            ...
            let dayTextureCutoutRectangle =
                uniformMapProperties.dayTextureCutoutRectangles[
                    numberOfDayTextures
                ];
        ...
        if (clippingPlanesEnabled) {
            ...
            uniformMapProperties.clippingPlanesEdgeWidth =
        ...
        surfaceShaderSetOptions.enableClippingPolygons =
            clippingPolygonsEnabled;
