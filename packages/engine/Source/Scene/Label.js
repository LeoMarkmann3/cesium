    ...
    scaleByDistance: {
        ...
        set: function (value) {
            ...
            if (!NearFarScalar.equals(scaleByDistance, value)) {
                this._scaleByDistance = NearFarScalar.clone(
                    value,
                    scaleByDistance,
                );
    ...
    pickId: {
        get: function () {
            if (
                ...
                !defined(this._glyphs[0].billboard)
            ) {
                return undefined;
            }
    ...
    return (
        ...
        (defined(other) &&
            ...
            this._disableDepthTestDistance ===
                other._disableDepthTestDistance &&
            this._id === other._id)
    );
};
                ...
                if (wordIndex > 0) {
                    ...
                    if (parsedText[wordIndex - 1].Type === textTypes.RTL) {
                        ...
                        if (parsedText.length > wordIndex + 1) {
                            // next word is rtl
                            if (
                                parsedText[wordIndex + 1].Type === textTypes.RTL
                            ) {
                                line = spliceWord(line, splicePointer, reverse);
                            } else {
                                line += subText.Word;
