...
class ModelImagery {
    ...
    update(frameState) {
        ...
        if (!defined(this._modelPrimitiveImageries)) {
            this._modelPrimitiveImageries =
                this._createModelPrimitiveImageries();
        }
    ...
    _createModelPrimitiveImageries() {
        ...
        const runtimeNodesAndPrimitives =
            this._collectRuntimeNodesAndPrimitives();
        ...
        for (let i = 0; i < length; i++) {
            ...
            runtimePrimitive.primitive.modelPrimitiveImagery =
    ...
    _imageryConfigurationsModified() {
        ...
        for (let i = 0; i < imageryLayers.length; i++) {
            ...
            if (
                imageryLayer.colorToAlpha !== imageryConfiguration.colorToAlpha
            ) {
                return true;
            }
        }
