...
class ImageryPipelineStage {
    ...
    static _processImageryInputs(
        ...
        const uniforms =
            ImageryPipelineStage._createImageryUniforms(imageryInputs);
    ...
    static _computeImageryFlags(imageryLayers) {
        ...
        for (let i = 0; i < imageryLayers.length; i++) {
            ...
            imageryFlags.gamma |=
                imageryLayer.gamma !== ImageryLayer.DEFAULT_GAMMA;
    ...
    static _buildSampleAndBlendFunction(shaderBuilder, imageryFlags) {
        const functionId = "sampleAndBlend";
        const signature =
            ImageryPipelineStage._createSampleAndBlendFunctionSignature(
                imageryFlags,
            );
        shaderBuilder.addFunction(
            functionId,
     ...
     * @param {ImageryFlags} imageryFlags The imagery flags
     */
    static _createMainImageryShader(
        shaderBuilder,
        imageryInputs,
        imageryFlags,
    ) {
    ...
    static _createImageryInputs(
        ...
        for (let i = 0; i < imageryLayers.length; i++) {
            ...
            const mappedPositions =
                modelPrimitiveImagery.mappedPositionsForImageryLayer(
                    imageryLayer,
                );
