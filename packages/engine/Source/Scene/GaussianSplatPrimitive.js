        ...
        if (this._needsGaussianSplatTexture) {
            if (!this._gaussianSplatTexturePending) {
                ...
                if (defined(this._shData)) {
                    ...
                    for (
                        let i = 0;
                        dataIndex < this._shData.length;
                        i += width * 2
                    ) {
                        texBuf.set(
                            this._shData.subarray(
                                dataIndex,
                    ...
                    this.sphericalHarmonicsTexture =
                        createSphericalHarmonicsTexture(frameState.context, {
                            data: texBuf,
                            width: width,
