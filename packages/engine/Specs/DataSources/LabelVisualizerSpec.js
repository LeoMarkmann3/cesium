...
describe(
    ...
    function () {
        ...
        it("A LabelGraphics causes a label to be created and updated.", function () {
            ...
            expect(l.fillColor).toEqual(
                testObject.label.fillColor.getValue(time),
            );
            ...
            expect(l.eyeOffset).toEqual(
                testObject.label.eyeOffset.getValue(time),
            );
