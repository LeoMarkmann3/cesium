...
describe(
    ...
    function () {
        ...
        it("A time-varying coordinates causes geometry to be dynamic", function () {
            ...
            entity.rectangle.coordinates.addSample(
                JulianDate.now(),
                new Rectangle(),
            );
            updater._onEntityPropertyChanged(entity, "rectangle");
        ...
        it("Creates geometry with expected properties", function () {
            ...
            rectangle.extrudedHeight = new ConstantProperty(
        ...
        it("dynamic updater sets properties", function () {
            const rectangle = new RectangleGraphics();
            rectangle.coordinates = createDynamicProperty(
                new Rectangle(0, 0, 1, 1),
            );
            ...
            expect(options.granularity).toEqual(
                rectangle.granularity.getValue(),
            );
