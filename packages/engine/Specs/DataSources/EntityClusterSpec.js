...
describe(
    ...
    function () {
        ...
        it("constructor sets expected properties", function () {
            ...
            expect(cluster.minimumClusterSize).toEqual(
                options.minimumClusterSize,
            );
            expect(cluster.clusterBillboards).toEqual(
        ...
        it("removes entity collection indices when billboard, label and point have been removed", function () {
            ...
            expect(
                cluster._collectionIndicesByEntity[entity.id],
            ).toBeUndefined();
        });
        ...
        it("custom cluster styling", function () {
            ...
            expect(cluster._clusterLabelCollection).toBeDefined();
            expect(cluster._clusterLabelCollection.length).toEqual(1);
            expect(cluster._clusterLabelCollection.get(0).text).toEqual(
                "cluster",
            );
