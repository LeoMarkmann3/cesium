...
describe("DataSources/ModelGraphics", function () {
    it("creates expected instance from raw assignment and construction", function () {
        ...
        expect(model.incrementallyLoadTextures).toBeInstanceOf(
            ConstantProperty,
        );
        ...
        expect(model.minimumPixelSize.getValue()).toEqual(
        ...
        expect(model.heightReference.getValue()).toEqual(
            options.heightReference,
        );
        expect(model.distanceDisplayCondition.getValue()).toEqual(
            options.distanceDisplayCondition,
        );
        expect(model.silhouetteColor.getValue()).toEqual(
        ...
        expect(model.colorBlendAmount.getValue()).toEqual(
        ...
        expect(model.clampAnimations.getValue()).toEqual(
        ...
        let actualArticulations = model.articulations.getValue(
            new JulianDate(),
        );
        ...
        expectedArticulations = JSON.parse(
            JSON.stringify(expectedArticulations),
        );
    ...
    it("merge assigns unassigned properties", function () {
        ...
        source.clippingPlanes = new ConstantProperty(
    ...
    it("merge does not assign assigned properties", function () {
        ...
        const clippingPlanes = new ConstantProperty(
            new ClippingPlaneCollection(),
        );
