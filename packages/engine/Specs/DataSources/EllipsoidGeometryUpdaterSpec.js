...
describe(
    ...
    function () {
        ...
        function createDynamicEllipsoid() {
            ...
            entity.ellipsoid.radii = createDynamicProperty(
        ...
        it("A time-varying innerRadii causes geometry to be dynamic", function () {
            ...
            entity.ellipsoid.innerRadii.addSample(
                time,
                new Cartesian3(1, 2, 3),
            );
            updater._onEntityPropertyChanged(entity, "ellipsoid");
        ...
        it("Creates geometry with expected properties", function () {
            ...
            ellipsoid.stackPartitions = new ConstantProperty(
                options.stackPartitions,
            );
            ellipsoid.slicePartitions = new ConstantProperty(
        ...
        it("dynamic ellipsoid creates and updates", function () {
            ...
            const entity = new Entity();
            entity.position = createDynamicProperty(
                Cartesian3.fromDegrees(0, 0, 0),
            );
        ...
        it("Inner radii should be set when not in 3D mode", function () {
            const ellipsoid = new EllipsoidGraphics();
            ellipsoid.radii = createDynamicProperty(new Cartesian3(1, 2, 3));
            ellipsoid.innerRadii = createDynamicProperty(
                new Cartesian3(0.5, 1, 1.5),
            );
        ...
        it("dynamic ellipsoid fast path updates attributes", function () {
            ...
            let attributes = primitives
                .get(0)
                .getGeometryInstanceAttributes(entity);
            expect(attributes.show[0]).toEqual(0);
            expect(
                primitives.get(0).appearance.material.uniforms.color,
            ).toEqual(ellipsoid.material.color.getValue());
        ...
        it("geometryChanged event is raised when expected", function () {
            ...
            entity.ellipsoid.radii = new ConstantProperty(
                new Cartesian3(1, 2, 3),
            );
            updater._onEntityPropertyChanged(entity, "ellipsoid");
