...
describe("DataSources/GpxDataSource", function () {
    ...
    it("Waypoint: uses default billboard style", function () {
        ...
        return GpxDataSource.load(parser.parseFromString(gpx, "text/xml")).then(
            function (dataSource) {
                const entities = dataSource.entities.values;
                expect(entities[0].billboard.height.getValue()).toEqual(
                    BILLBOARD_SIZE,
                );
                expect(entities[0].billboard.width.getValue()).toEqual(
                    BILLBOARD_SIZE,
                );
    ...
    it("Waypoint: handles multiple waypoints", function () {
        ...
        return GpxDataSource.load(parser.parseFromString(gpx, "text/xml")).then(
            function (dataSource) {
                ...
                expect(
                    entities[0].position.getValue(Iso8601.MINIMUM_VALUE),
                ).toEqual(Cartesian3.fromDegrees(1, 2, undefined));
                expect(
                    entities[1].position.getValue(Iso8601.MINIMUM_VALUE),
                ).toEqual(Cartesian3.fromDegrees(3, 4, undefined));
                expect(
                    entities[2].position.getValue(Iso8601.MINIMUM_VALUE),
                ).toEqual(Cartesian3.fromDegrees(5, 6, undefined));
            },
        );
    });
        ...
        return GpxDataSource.load(parser.parseFromString(gpx, "text/xml")).then(
            function (dataSource) {
                ...
                expect(div.textContent).toEqual(
                    "GPS track/route number: The number",
                );
            },
        );
    });
    ...
    it("Route: handles simple route", function () {
        ...
        return GpxDataSource.load(parser.parseFromString(gpx, "text/xml")).then(
            function (dataSource) {
                ...
                expect(
                    entities[1].position.getValue(Iso8601.MINIMUM_VALUE),
                ).toEqual(Cartesian3.fromDegrees(1, 2, 1));
                expect(
                    entities[2].position.getValue(Iso8601.MINIMUM_VALUE),
                ).toEqual(Cartesian3.fromDegrees(3, 4, 1));
                expect(
                    entities[3].position.getValue(Iso8601.MINIMUM_VALUE),
                ).toEqual(Cartesian3.fromDegrees(5, 6, 1));
                expect(
                    entities[4].position.getValue(Iso8601.MINIMUM_VALUE),
                ).toEqual(Cartesian3.fromDegrees(7, 8, 1));
            },
        );
    });
    ...
    it("Track: uses default polyline style", function () {
        ...
        return GpxDataSource.load(parser.parseFromString(gpx, "text/xml")).then(
            function (dataSource) {
                ...
                expect(
                    entity.polyline.material.outlineWidth.getValue(),
                ).toEqual(2);
                expect(
