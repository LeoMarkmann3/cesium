...
describe(
    ...
    function () {
        ...
        it("A time-varying cornerType causes geometry to be dynamic", function () {
            const entity = createBasicPolylineVolume();
            const updater = new PolylineVolumeGeometryUpdater(entity, scene);
            entity.polylineVolume.cornerType =
        ...
        it("Creates geometry with expected properties", function () {
            ...
            polylineVolume.cornerType = new ConstantProperty(
                options.cornerType,
            );
            polylineVolume.shape = new ConstantProperty(options.shape);
            polylineVolume.granularity = new ConstantProperty(
                options.granularity,
            );
        ...
        it("dynamic updater sets properties", function () {
            ...
            polylineVolume.cornerType = createDynamicProperty(
                CornerType.MITERED,
            );
            ...
            expect(options.shapePositions).toEqual(
                polylineVolume.shape.getValue(),
            );
            expect(options.granularity).toEqual(
                polylineVolume.granularity.getValue(),
            );
            expect(options.cornerType).toEqual(
                polylineVolume.cornerType.getValue(),
            );
        });
