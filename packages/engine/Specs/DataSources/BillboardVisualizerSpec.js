...
describe(
    ...
    function () {
        ...
        it("update throws if no time specified.", function () {
            ...
            visualizer = new BillboardVisualizer(
                entityCluster,
                entityCollection,
            );
            expect(function () {
        ...
        it("A BillboardGraphics causes a Billboard to be created and updated.", async function () {
            ...
            billboard.show = new ConstantProperty(true);
            billboard.color = new ConstantProperty(
            ...
            billboard.horizontalOrigin = new ConstantProperty(
            ...
            billboard.splitDirection = new ConstantProperty(
                SplitDirection.LEFT,
            );
