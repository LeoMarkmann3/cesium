...
describe("DataSources/exportKml", function () {
    ...
    function checkTagWithProperties(element, properties) {
        ...
        if (defined(attributes)) {
            ...
            expect(elementAttributes.length).toBe(
    ...
    describe("Point Geometry", function () {
        ...
        it("Billboard with a Canvas image", function () {
            ...
            return checkKmlDoc(entities, expectedResult).then(
                function (result) {
            ...
            return exportKml({
                ...
                return new Promise((resolve) => {
                    ...
                    fileReader.onload = function (event) {
                        ...
                        expect(
                            new DataView(event.target.result).getUint32(
                                0,
                                false,
                            ),
                        ).toBe(0x504b0304);
    ...
    describe("Tracks", function () {
        ...
        it("CallbackProperty", function () {
            ...
            checkKmlDoc(entities, expectedResult, {
                ...
                sampleDuration: JulianDate.secondsDifference(
                    times[1],
                    times[0],
                ),
            });
