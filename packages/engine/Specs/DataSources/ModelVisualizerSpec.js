...
describe(
    ...
    function () {
        ...
        it("creates and updates a primitive from ModelGraphics", async function () {
            ...
            model.lightColor = new ConstantProperty(
            ...
            expect(
                primitive.imageBasedLighting.imageBasedLightingFactor,
            ).toEqual(new Cartesian2(0.5, 0.5));

            expect(primitive.lightColor).toEqual(new Cartesian3(1.0, 1.0, 0.0));

            expect(primitive.environmentMapManager.enabled).toBeTrue();
            expect(
                primitive.environmentMapManager.maximumPositionEpsilon,
        ...
        it("can apply model articulations", async function () {
            ...
            const expected = [
                0.7147690483240505, -0.04340611926232735, -0.0749741046529782,
                0, -0.06188330295778636, 0.05906797312763484,
                -0.6241645867602773, 0, 0.03752515582279579, 0.5366347296529127,
                0.04706410108373541, 0, 1, 3, -2, 1,
            ];
