...
describe("DataSources/SampledProperty", function () {
    it("constructor sets expected defaults", function () {
        ...
        expect(property.forwardExtrapolationType).toEqual(
            ExtrapolationType.NONE,
        );
        expect(property.forwardExtrapolationDuration).toEqual(0);
        expect(property.backwardExtrapolationType).toEqual(
            ExtrapolationType.NONE,
        );
    ...
    it("can remove samples for a time interval", function () {
        ...
        expect(property.getValue(times[2])).toEqual(
            (values[0] + values[4]) / 2,
        );
        expect(property.getValue(times[4])).toEqual(values[4]);
    ...
    const interwovenData = [
        {
            ...
            values: [
                0.0, 1, 120.0, 2, 240.0, 3, 360.0, 4, 480.0, 6, 600.0, 8, 720.0,
                10, 840.0, 12, 960.0, 14, 1080.0, 16,
            ],
        },
        {
            epoch: JulianDate.fromIso8601("20130205T151151.60499999999956Z"),
            values: [
                0.0, 5, 120.0, 7, 240.0, 9, 360.0, 11, 480.0, 13, 600.0, 15,
                720.0, 17, 840.0, 18, 960.0, 19, 1080.0, 20,
            ],
        },
    ];
