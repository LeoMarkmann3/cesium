...
describe("DataSources/BillboardGraphics", function () {
    it("creates expected instance from raw assignment and construction", function () {
        ...
        expect(billboard.translucencyByDistance).toBeInstanceOf(
            ConstantProperty,
        );
        ...
        expect(billboard.distanceDisplayCondition).toBeInstanceOf(
            ConstantProperty,
        );
        expect(billboard.disableDepthTestDistance).toBeInstanceOf(
            ConstantProperty,
        );
        ...
        expect(billboard.verticalOrigin.getValue()).toEqual(
        ...
        expect(billboard.splitDirection.getValue()).toEqual(
    ...
    it("merge assigns unassigned properties", function () {
        ...
        source.translucencyByDistance = new ConstantProperty(
            new NearFarScalar(),
        );
        ...
        expect(target.translucencyByDistance).toBe(
    ...
    it("merge does not assign assigned properties", function () {
        ...
        const translucencyByDistance = new ConstantProperty(
            new NearFarScalar(),
        );
    ...
    it("clone works", function () {
        ...
        expect(result.translucencyByDistance).toBe(
            source.translucencyByDistance,
        );
