...
describe(
    ...
    function () {
        ...
        it("creates with defaults", function () {
            ...
            expect(rs.polygonOffset.enabled).toEqual(
                defaultRS.polygonOffset.enabled,
            );
            expect(rs.polygonOffset.factor).toEqual(
                defaultRS.polygonOffset.factor,
            );
            expect(rs.polygonOffset.units).toEqual(
                defaultRS.polygonOffset.units,
            );
            expect(rs.scissorTest.enabled).toEqual(
                defaultRS.scissorTest.enabled,
            );
            ...
            expect(rs.blending.color.green).toEqual(
                defaultRS.blending.color.green,
            );
            expect(rs.blending.color.blue).toEqual(
                defaultRS.blending.color.blue,
            );
            expect(rs.blending.color.alpha).toEqual(
                defaultRS.blending.color.alpha,
            );
            expect(rs.blending.equationRgb).toEqual(
                defaultRS.blending.equationRgb,
            );
            ...
            expect(rs.stencilTest.enabled).toEqual(
                defaultRS.stencilTest.enabled,
            );
            ...
            expect(rs.stencilTest.reference).toEqual(
                defaultRS.stencilTest.reference,
            );
            ...
            expect(rs.sampleCoverage.value).toEqual(
                defaultRS.sampleCoverage.value,
            );
            expect(rs.sampleCoverage.invert).toEqual(
                defaultRS.sampleCoverage.invert,
            );
        });
        ...
        it("creates with all render states", function () {
            ...
            expect(rs.scissorTest.rectangle.x).toEqual(
                r.scissorTest.rectangle.x,
            );
            expect(rs.scissorTest.rectangle.y).toEqual(
                r.scissorTest.rectangle.y,
            );
            expect(rs.scissorTest.rectangle.width).toEqual(
            ...
            expect(rs.stencilTest.frontFunction).toEqual(
                r.stencilTest.frontFunction,
            );
            expect(rs.stencilTest.backFunction).toEqual(
                r.stencilTest.backFunction,
            );
