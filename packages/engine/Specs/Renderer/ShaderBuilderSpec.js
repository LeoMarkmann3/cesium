...
describe(
    ...
    function () {
        ...
        it("addFunctionLines throws for undefined lines", function () {
            ...
            expect(function () {
                return shaderBuilder.addFunctionLines(
                    "testFunctionVS",
                    undefined,
                );
            }).toThrowDeveloperError();
        ...
        it("setPositionAttribute throws for undefined type", function () {
            const shaderBuilder = new ShaderBuilder();
            expect(function () {
                return shaderBuilder.setPositionAttribute(
                    undefined,
                    "a_position",
                );
            }).toThrowDeveloperError();
        ...
        it("setPositionAttribute creates a position attribute in location 0", function () {
            ...
            const normalLocation = shaderBuilder.addAttribute(
                "vec3",
                "a_normal",
            );
        ...
        it("addAttribute handles matrix attribute locations correctly", function () {
            ...
            const matrixLocation = shaderBuilder.addAttribute(
                "mat3",
                "a_warpMatrix",
            );
