...
describe(
    ...
    function () {
        ...
        it("creates a vertex array with static floats", function () {
            ...
            expect(
                vaf.va[0].va.getAttribute(0).vertexBuffer.sizeInBytes,
            ).toEqual(1 * 3 * 4);
            expect(vaf.va[0].va.getAttribute(0).vertexBuffer.usage).toEqual(
                BufferUsage.STATIC_DRAW,
            );
            expect(vaf.va[0].va.getAttribute(0).componentsPerAttribute).toEqual(
                3,
            );
        ...
        it("creates a vertex array with static floats and unsigned bytes", function () {
            ...
            expect(vaf.va[0].va.getAttribute(0).offsetInBytes).toEqual(0);
            expect(vaf.va[0].va.getAttribute(0).strideInBytes).toEqual(
                3 * 4 + 4 * 1,
            );
            ...
            expect(vaf.va[0].va.getAttribute(1).componentsPerAttribute).toEqual(
                4,
            );
        ...
        it("creates a vertex array with static and dynamic attributes", function () {
            ...
            expect(
                vaf.va[0].va.getAttribute(1).vertexBuffer.sizeInBytes,
            ).toEqual(1 * (2 * 2));
