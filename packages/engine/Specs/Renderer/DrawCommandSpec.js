...
describe("Renderer/DrawCommand", function () {
    ...
    it("shallow clones", function () {
        ...
        expect(clone.executeInClosestFrustum).toEqual(
            c.executeInClosestFrustum,
        );
        expect(clone.owner).toBe(c.owner);
        expect(clone.debugShowBoundingVolume).toEqual(
            c.debugShowBoundingVolume,
        );
        expect(clone.debugOverlappingFrustums).toEqual(
            c.debugOverlappingFrustums,
        );
