...
describe("Scene/TextureAtlas", function () {
    ...
    beforeAll(function () {
        return Promise.all([
            Resource.fetchImage("./Data/Images/Green.png").then(
                function (image) {
                    greenImage = image;
            ...
            Resource.fetchImage("./Data/Images/Blue.png").then(
                function (image) {
                    blueImage = image;
                    blueGuid = createGuid();
                },
    ...
    describe(
        ...
        function () {
            ...
            function createRenderResources(texture, textureCoordinates) {
                ...
                const y =
                    textureCoordinates.y + textureCoordinates.height / 2.0;
                const fs =
                    `${
            ...
            it("adds a promised image to an atlas", async function () {
                ...
                const promise = atlas.addImage(
                    greenGuid,
                    Promise.resolve(greenImage),
                );
            ...
            it("computes subregion texture coordinates", async function () {
                ...
                const imagePromise0 = atlas.addImage(
                    bigGreenGuid,
                    bigGreenImage,
                );
          ...
          `.trim(),
            ...
            it("add image resizes the initial texture atlas if needed", async function () {
                ...
                let textureCoordinates =
                    atlas.computeTextureCoordinates(index0);
                expect(
...
................................
          `.trim(),
            ...
            it("allocates appropriate space on resize", async function () {
                ...
                expect(atlasWidth * atlasHeight).toBeLessThanOrEqual(
                    inputPixels * 3,
                );
                ...
                async function addImages(count) {
                    ...
                    const imageUrl = createImageDataURL(
                        imageWidth,
                        imageHeight,
                    );
