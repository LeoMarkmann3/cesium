...
describe("Core/DistanceDisplayCondition", function () {
    ...
    it("determines equality with prototype function", function () {
        const dc = new DistanceDisplayCondition(10.0, 100.0);
        expect(dc.equals(new DistanceDisplayCondition(10.0, 100.0))).toEqual(
            true,
        );
        expect(dc.equals(new DistanceDisplayCondition(11.0, 100.0))).toEqual(
            false,
        );
        expect(dc.equals(new DistanceDisplayCondition(10.0, 101.0))).toEqual(
            false,
        );
