...
describe("Core/S2Cell", function () {
    ...
    it("creates cell from valid face, position, level", function () {
        ...
        cell = S2Cell.fromFacePositionLevel(
            1,
            BigInt("538969508876688737"),
            30,
        );
    ...
    it("correctly converts cell ID to token", function () {
        expect(S2Cell.getIdFromToken("04")).toEqual(
            BigInt("288230376151711744"),
        );
        expect(S2Cell.getIdFromToken("3")).toEqual(
            BigInt("3458764513820540928"),
        );
    ...
    it("correctly converts token to cell ID", function () {
        expect(S2Cell.getTokenFromId(BigInt("288230376151711744"))).toEqual(
            "04",
        );
        expect(S2Cell.getTokenFromId(BigInt("3458764513820540928"))).toEqual(
            "3",
        );
