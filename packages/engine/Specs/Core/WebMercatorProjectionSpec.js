...
describe("Core/WebMercatorProjection", function () {
    ...
    it("unproject is correct at corners", function () {
        ...
        expect(southwest.longitude).toEqualEpsilon(
            -Math.PI,
        ...
        expect(southeast.longitude).toEqualEpsilon(
            Math.PI,
            CesiumMath.EPSILON12,
        );
        ...
        expect(northeast.longitude).toEqualEpsilon(
            Math.PI,
            CesiumMath.EPSILON12,
        );
        ...
        expect(northwest.longitude).toEqualEpsilon(
            -Math.PI,
            CesiumMath.EPSILON12,
        );
    ...
    it("project is correct at corners.", function () {
        ...
        expect(southwest.x).toEqualEpsilon(
            -20037508.342787,
            CesiumMath.EPSILON3,
        );
        expect(southwest.y).toEqualEpsilon(
            -20037508.342787,
            CesiumMath.EPSILON3,
        );
        ...
        expect(southeast.x).toEqualEpsilon(
            20037508.342787,
            CesiumMath.EPSILON3,
        );
        expect(southeast.y).toEqualEpsilon(
            -20037508.342787,
            CesiumMath.EPSILON3,
        );
        ...
        expect(northeast.x).toEqualEpsilon(
            20037508.342787,
            CesiumMath.EPSILON3,
        );
        expect(northeast.y).toEqualEpsilon(
            20037508.342787,
            CesiumMath.EPSILON3,
        );
        ...
        expect(northwest.x).toEqualEpsilon(
            -20037508.342787,
            CesiumMath.EPSILON3,
        );
        expect(northwest.y).toEqualEpsilon(
            20037508.342787,
            CesiumMath.EPSILON3,
        );
    });
