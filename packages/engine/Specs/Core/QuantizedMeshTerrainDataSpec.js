...
describe("Core/QuantizedMeshTerrainData", function () {
    ...
    describe("upsample", function () {
        function findVertexWithCoordinates(uBuffer, vBuffer, u, v) {
            ...
            for (let i = 0; i < uBuffer.length; ++i) {
                if (
                    Math.abs(uBuffer[i] - u) <= 1 &&
                    Math.abs(vBuffer[i] - v) <= 1
                ) {
                    return i;
                }
            }
            ...
            return Promise.resolve(
                ...
                .then(function (upsampleResults) {
                    ...
                    for (let i = 0; i < upsampleResults.length; ++i) {
                        ...
                        const sw = findVertexWithCoordinates(
                            uBuffer,
                            vBuffer,
                            0.0,
                            0.0,
                        ...
                        const nw = findVertexWithCoordinates(
                            uBuffer,
                            vBuffer,
                            0.0,
                            1.0,
                        ...
                        const se = findVertexWithCoordinates(
                            uBuffer,
                            vBuffer,
                            1.0,
                            0.0,
                        ...
                        const ne = findVertexWithCoordinates(
                            uBuffer,
                            vBuffer,
                            1.0,
                            1.0,
                        ...
                        const nwToSe =
                            hasTriangle(ib, sw, se, nw) &&
                            hasTriangle(ib, nw, se, ne);
                        const swToNe =
                            hasTriangle(ib, sw, ne, nw) &&
                            hasTriangle(ib, sw, se, ne);
        ...
        it("works for a quad with an extra vertex in the northwest child", function () {
            ...
            return Promise.resolve(
                ...
                .then(function (upsampled) {
                    ...
                    expect(ne).not.toBe(-1);
                    const extra = findVertexWithCoordinates(
                        uBuffer,
                        vBuffer,
                        0.25,
                        0.5,
        ...
        it("works for a quad with an extra vertex on the splitting plane", function () {
            ...
            return Promise.resolve(
                ...
                .then(function (upsampleResults) {
                    ...
                    let extra = findVertexWithCoordinates(
                        uBuffer,
                        vBuffer,
                        1.0,
                        0.5,
                    ...
                    extra = findVertexWithCoordinates(
                        uBuffer,
                        vBuffer,
                        0.0,
                        0.5,
            ...
            return data
                ...
                .then(function (mesh) {
                    ...
                    expect(mesh.vertices.length).toBe(
                        12 * mesh.encoding.stride,
                    ); // 4 regular vertices, 8 skirt vertices.
    ...
    describe("interpolateHeight", function () {
        ...
        it("returns a height interpolated from the correct triangle", function () {
            ...
            let longitude =
                rectangle.west + (rectangle.east - rectangle.west) * 0.25;
            let latitude =
            ...
            latitude =
                rectangle.south + (rectangle.north - rectangle.south) * 0.25;
            ...
            longitude =
                rectangle.west + (rectangle.east - rectangle.west) * 0.5;
            latitude =
                rectangle.south + (rectangle.north - rectangle.south) * 0.5;
