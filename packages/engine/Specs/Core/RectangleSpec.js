...
describe("Core/Rectangle", function () {
    ...
    it("fromCartesianArray produces expected values.", function () {
        ...
        const rectangle = Rectangle.fromCartesianArray(
            wgs84.cartographicArrayToCartesianArray([
                minLat,
                minLon,
                maxLat,
                maxLon,
    ...
    it("Equals works in all cases", function () {
        ...
        expect(rectangle.equals(new Rectangle(0.1, 0.2, 0.3, 0.4))).toEqual(
            true,
        );
        expect(rectangle.equals(new Rectangle(0.5, 0.2, 0.3, 0.4))).toEqual(
            false,
        );
        expect(rectangle.equals(new Rectangle(0.1, 0.5, 0.3, 0.4))).toEqual(
            false,
        );
        expect(rectangle.equals(new Rectangle(0.1, 0.2, 0.5, 0.4))).toEqual(
            false,
        );
        expect(rectangle.equals(new Rectangle(0.1, 0.2, 0.3, 0.5))).toEqual(
            false,
        );
    ...
    it("Static equals epsilon works in all cases", function () {
        ...
        expect(Rectangle.equalsEpsilon(rectangle1, undefined, 0.0)).toEqual(
            false,
        );
        expect(Rectangle.equalsEpsilon(undefined, rectangle1, 0.0)).toEqual(
            false,
        );
        expect(Rectangle.equalsEpsilon(rectangle1, rectangle1, 0.0)).toEqual(
            true,
        );
    });
    ...
    it("intersection works across the IDL (1)", function () {
        ...
        expect(Rectangle.intersection(rectangle1, rectangle2)).toEqual(
            expected,
        );
        expect(Rectangle.intersection(rectangle2, rectangle1)).toEqual(
            expected,
        );
    });
    ...
    it("intersection returns undefined for a point", function () {
        ...
        expect(
            Rectangle.intersection(rectangle2, rectangle1),
        ).not.toBeDefined();
    });
    ...
    it("expand works with a result parameter", function () {
        ...
        const result = new Rectangle();
        const returnedResult = Rectangle.expand(
            rectangle,
            cartographic,
            result,
        );
    ...
    it("contains works", function () {
        ...
        expect(
            Rectangle.contains(rectangle, Rectangle.center(rectangle)),
        ).toEqual(true);
        expect(
    ...
    it("subsample works on the equator", function () {
        ...
        expect(cartographic4.longitude).toEqualEpsilon(
            west,
        ...
        expect(cartographic5.longitude).toEqualEpsilon(
            east,
            CesiumMath.EPSILON16,
        );
    });
    ...
    it("subsection works with rectangle that crosses IDL and subsection that crosses IDL", function () {
        ...
        expect(subsection).toEqualEpsilon(
            expectedRectangle,
