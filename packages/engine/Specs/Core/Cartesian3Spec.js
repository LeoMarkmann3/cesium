...
describe("Core/Cartesian3", function () {
    ...
    it("minimumByComponent with a result parameter", function () {
        ...
        const result = new Cartesian3();
        const returnedResult = Cartesian3.minimumByComponent(
            first,
            second,
            result,
        );
    ...
    it("maximumByComponent with a result parameter", function () {
        ...
        const result = new Cartesian3();
        const returnedResult = Cartesian3.maximumByComponent(
            first,
            second,
            result,
        );
    ...
    it("multiplyComponents works with a result parameter", function () {
        ...
        const returnedResult = Cartesian3.multiplyComponents(
            left,
            right,
            result,
        );
    ...
    it("equals", function () {
        const cartesian = new Cartesian3(1.0, 2.0, 3.0);
        expect(
            Cartesian3.equals(cartesian, new Cartesian3(1.0, 2.0, 3.0)),
        ).toEqual(true);
        expect(
            Cartesian3.equals(cartesian, new Cartesian3(2.0, 2.0, 3.0)),
        ).toEqual(false);
        expect(
            Cartesian3.equals(cartesian, new Cartesian3(2.0, 1.0, 3.0)),
        ).toEqual(false);
        expect(
            Cartesian3.equals(cartesian, new Cartesian3(1.0, 2.0, 4.0)),
        ).toEqual(false);
    ...
    it("equalsEpsilon", function () {
        ...
        expect(
            cartesian.equalsEpsilon(new Cartesian3(1.0, 2.0, 3.0), 0.0),
        ).toEqual(true);
        expect(
            cartesian.equalsEpsilon(new Cartesian3(1.0, 2.0, 3.0), 1.0),
        ).toEqual(true);
        expect(
            cartesian.equalsEpsilon(new Cartesian3(2.0, 2.0, 3.0), 1.0),
        ).toEqual(true);
        expect(
            cartesian.equalsEpsilon(new Cartesian3(1.0, 3.0, 3.0), 1.0),
        ).toEqual(true);
        expect(
            cartesian.equalsEpsilon(new Cartesian3(1.0, 2.0, 4.0), 1.0),
        ).toEqual(true);
        expect(
        ...
        expect(Cartesian3.equalsEpsilon(undefined, cartesian, 1)).toEqual(
            false,
        );
    });
    ...
    it("fromDegrees with result", function () {
        ...
        const ellipsoid = Ellipsoid.WGS84;
        const result = new Cartesian3();
        const actual = Cartesian3.fromDegrees(
            lon,
            lat,
            height,
            ellipsoid,
    ...
    it("fromRadians with result", function () {
        ...
        const ellipsoid = Ellipsoid.WGS84;
        const result = new Cartesian3();
        const actual = Cartesian3.fromRadians(
            lon,
            lat,
            height,
            ellipsoid,
    ...
    it("fromRadiansArray works works with default ellipsoid", function () {
        ...
        const positions = Cartesian3.fromRadiansArray([
            0.40968375, 0.01176631, 5.97812531, -0.06360276, 0.06332927,
            0.45611405,
        ]);
        expect(positions).toEqualEpsilon(
            expectedPositions,
    ...
    it("fromDegreesArrayHeights works works with default ellipsoid", function () {
        ...
        const positions = Cartesian3.fromDegreesArrayHeights([
            23.47315, 0.67416, 100, 342.52135, -3.64417, 100, 3.6285, 26.13341,
            100,
        ]);
        expect(positions).toEqualEpsilon(
            expectedPositions,
    ...
    it("fromRadiansArrayHeights works works with default ellipsoid", function () {
        ...
        const positions = Cartesian3.fromRadiansArrayHeights([
            0.40968375, 0.01176631, 100, 5.97812531, -0.06360276, 100,
            0.06332927, 0.45611405, 100,
        ]);
        expect(positions).toEqualEpsilon(
            expectedPositions,
            CesiumMath.EPSILON8,
