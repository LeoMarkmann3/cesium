...
describe("Core/EllipseOutlineGeometry", function () {
    ...
    it("undefined is returned if the minor axis is equal to or less than zero", function () {
        ...
        const geometry0 =
            EllipseOutlineGeometry.createGeometry(ellipseOutline0);
        const geometry1 =
            EllipseOutlineGeometry.createGeometry(ellipseOutline1);
        const geometry2 =
            EllipseOutlineGeometry.createGeometry(ellipseOutline2);
        const geometry3 =
            EllipseOutlineGeometry.createGeometry(ellipseOutline3);
