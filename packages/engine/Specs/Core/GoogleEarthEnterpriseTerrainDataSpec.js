...
describe("Core/GoogleEarthEnterpriseTerrainData", function () {
    ...
    it("conforms to TerrainData interface", function () {
        expect(GoogleEarthEnterpriseTerrainData).toConformToInterface(
            TerrainData,
        );
    });
                ...
                .then(function (upsampleResults) {
                    ...
                    for (let i = 0; i < upsampleResults.length; ++i) {
                        ...
                        for (let j = 0; j < ib.length; ++j) {
                            index = ib[j];
                            u =
                                (uBuffer[index] / maxShort) * rectangle.width +
                                rectangle.west;
                            v =
                ...
                .then(function (mesh) {
                    ...
                    for (let i = 0; i < count; ++i) {
                        ...
                        if (i < 9) {
                            ...
                            encoding.decodePosition(
                                mesh.vertices,
                                i,
                                cartesian,
                            );
                            wgs84.cartesianToCartographic(
                                cartesian,
                                cartographic,
                            );
