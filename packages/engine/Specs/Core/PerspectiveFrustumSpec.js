...
describe("Core/PerspectiveFrustum", function () {
    ...
    it("get frustum bottom plane", function () {
        ...
        expect(bottomPlane).toEqualEpsilon(
            expectedResult,
    ...
    it("get sseDenominator", function () {
        expect(frustum.sseDenominator).toEqualEpsilon(
            1.1547,
            CesiumMath.EPSILON5,
        );
    });
    ...
    it("equals epsilon", function () {
        ...
        frustum2.fov = Math.PI / 3.0;
        frustum2.aspectRatio = 1.0;
        expect(frustum.equalsEpsilon(frustum2, CesiumMath.EPSILON7)).toEqual(
            true,
        );
        ...
        expect(frustum.equalsEpsilon(frustum3, CesiumMath.EPSILON1)).toEqual(
            true,
        );
        ...
        expect(frustum.equalsEpsilon(frustum4, CesiumMath.EPSILON2)).toEqual(
            false,
        );
    });
