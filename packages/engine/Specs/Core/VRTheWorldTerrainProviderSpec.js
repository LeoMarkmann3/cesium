...
describe("Core/VRTheWorldTerrainProvider", function () {
    ...
    let originalRequestersPerServer;
    beforeEach(function () {
        RequestScheduler.clearForSpecs();
        originalRequestersPerServer = RequestScheduler.maximumRequestsPerServer;
    });
    ...
    it("credit is defined if credit option is provided", async function () {
        patchXHRLoad();
        const provider = await VRTheWorldTerrainProvider.fromUrl(
            "made/up/url",
            {
    ...
    describe("requestTileGeometry", function () {
        it("provides HeightmapTerrainData", async function () {
            ...
            const terrainProvider =
                await VRTheWorldTerrainProvider.fromUrl(baseUrl);
