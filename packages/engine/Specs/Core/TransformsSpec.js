...
describe("Core/Transforms", function () {
    ...
    it("normal use of localFrameToFixedFrameGenerator", function () {
        ...
        const converterTab = [
            {
                converter: Transforms.localFrameToFixedFrameGenerator(
                    "north",
                    "east",
                ),
    ...
    it("headingPitchRollToFixedFrame works without a result parameter", function () {
        ...
        const expectedX = Matrix3.getColumn(
            expectedRotation,
            0,
            new Cartesian3(),
        );
        const expectedY = Matrix3.getColumn(
            expectedRotation,
            1,
            new Cartesian3(),
        );
        const expectedZ = Matrix3.getColumn(
            expectedRotation,
            2,
            new Cartesian3(),
        );
    ...
    it("headingPitchRollToFixedFrame works with a custom fixedFrameTransform", function () {
        ...
        const expectedUp = Matrix3.getColumn(
            expectedRotation,
            2,
            new Cartesian3(),
        ); // up
        ...
        const UNEFixedFrameConverter =
            Transforms.localFrameToFixedFrameGenerator("west", "south"); // up north east
    ...
    it("pointToGLWindowCoordinates works at the lower left", function () {
        const z =
            -perspective[Matrix4.COLUMN3ROW2] /
            perspective[Matrix4.COLUMN2ROW2];
    ...
    it("ellipsoidTo2DModelMatrix creates a model matrix to transform vertices centered origin to 2D", function () {
        ...
        const toENUTranslation = Matrix4.getTranslation(
            toENU,
            new Cartesian4(),
        );
        ...
        const actualTranslation = Matrix4.getTranslation(
            actual,
            new Cartesian4(),
        );
