...
describe("Core/Cartesian4", function () {
    ...
    it("fromArray with an offset creates a Cartesian4", function () {
        const cartesian = Cartesian4.fromArray(
    ...
    it("minimumByComponent with a result parameter", function () {
        ...
        const result = new Cartesian4();
        const returnedResult = Cartesian4.minimumByComponent(
            first,
            second,
            result,
        );
    ...
    it("maximumByComponent with a result parameter", function () {
        ...
        const result = new Cartesian4();
        const returnedResult = Cartesian4.maximumByComponent(
            first,
            second,
            result,
        );
    ...
    it("multiplyComponents works with a result parameter", function () {
        ...
        const returnedResult = Cartesian4.multiplyComponents(
            left,
            right,
            result,
        );
    ...
    it("equalsEpsilon", function () {
        ...
        expect(Cartesian4.equalsEpsilon(undefined, cartesian, 1)).toEqual(
            false,
        );
    });
