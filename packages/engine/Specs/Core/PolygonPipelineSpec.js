...
describe("Core/PolygonPipeline", function () {
    ...
    describe("triangulate", function () {
        ...
        it("eliminates holes", function () {
            ...
            expect(indices).toEqual([
                0, 4, 7, 5, 4, 0, 3, 0, 7, 5, 0, 1, 2, 3, 7, 6, 5, 1, 2, 7, 6,
                6, 1, 2,
            ]);
        });
        ...
        it("eliminates multiple holes", function () {
            ...
            const combinedPositions = positions
                .concat(bottomHole)
                .concat(topHole);
            ...
            expect(indices).toEqual([
                0, 8, 11, 0, 4, 7, 5, 4, 0, 3, 0, 11, 8, 0, 7, 5, 0, 1, 2, 3,
                11, 9, 8, 7, 6, 5, 1, 2, 11, 10, 9, 7, 6, 6, 1, 2, 2, 10, 9, 9,
                6, 2,
            ]);
        });
    });
    ...
    it("computeRhumbLineSubdivision without subdivisions", function () {
        ...
        expect(subdivision.attributes.position.values[6]).toEqual(
            positions[2].x,
        );
        expect(subdivision.attributes.position.values[7]).toEqual(
            positions[2].y,
        );
        expect(subdivision.attributes.position.values[8]).toEqual(
            positions[2].z,
        );
