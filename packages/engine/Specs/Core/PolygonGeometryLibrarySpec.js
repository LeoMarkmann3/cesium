    ...
    describe("splitPolygonsOnEquator", function () {
        it("splits a simple polygon at the equator", function () {
            const positions = Cartesian3.unpackArray([
                3813220.0, -5085291.0, 527179.0, 3701301.0, -5097773.0,
                -993503.0, 5037375.0, -3776794.0, -1017021.0, 5049166.0,
                -3865306.0, 494270.0,
            ]);
        ...
        it("does not split a simple polygon with one position touching the equator", function () {
            const positions = Cartesian3.unpackArray([
                3813220.0, -5085291.0, 527179.0, 3701301.0, -5097773.0, 0.0,
        ...
        it("splits a positively concave polygon with a point on the equator", function () {
            const positions = Cartesian3.unpackArray([
                -3592289.0, -5251493.0, 433532.0, -3568746.0, -5245699.0,
                -646544.0, -2273628.0, -5915229.0, -715098.0, -2410175.0,
                -5885323.0, 475855.0, -3012338.0, -5621469.0, 0.0,
            ]);
        ...
        it("splits a negatively concave polygon with a point on the equator", function () {
            const positions = Cartesian3.unpackArray([
                -3774632.0, -5136123.0, 222459.0, -3714187.0, -5173580.0,
                -341046.0, -3516544.0, -5320967.0, 0.0, -3304860.0, -5444086.0,
                -342567.0, -3277484.0, -5466977.0, 218213.0,
            ]);
        ...
        it("splits a polygon with an edge equator", function () {
            const positions = Cartesian3.unpackArray([
                -3227931.0, -5469496.0, 584508.0, -3150093.0, -5488360.0,
                -792747.0, -1700622.0, -6089685.0, -835364.0, -1786389.0,
                -6122714.0, 0.0, -2593600.0, -5826977.0, 0.0, -2609132.0,
                -5790155.0, 584508.0,
            ]);
        ...
        it("splits a polygon with a backtracking edge on the equator", function () {
            const positions = Cartesian3.unpackArray([
                ...
                -2403691.0, -5827997.0, -943662.0, -2484409.0, -5837281.0,
                631344.0,
            ]);
