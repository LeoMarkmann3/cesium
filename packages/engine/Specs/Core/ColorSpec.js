...
describe("Core/Color", function () {
    ...
    it("toCssHexString produces expected output", function () {
        ...
        expect(new Color(0.0, 0.0, 0.0, 1.0).toCssHexString()).toEqual(
            "#000000",
        );
        expect(new Color(0.1, 0.2, 0.3, 0.4).toCssHexString()).toEqual(
            "#19334c66",
        );
    });
    ...
    it("fromCssColorString supports the rgba() format with absolute values", function () {
        expect(Color.fromCssColorString("rgba(255, 0, 0, 1.0)")).toEqual(
            Color.RED,
        );
    ...
    it("fromCssColorString supports the hsl() format", function () {
        expect(Color.fromCssColorString("hsl(0, 100%, 50%)")).toEqual(
            Color.RED,
        );
        expect(Color.fromCssColorString("hsl(120, 100%, 50%)")).toEqual(
            Color.LIME,
        );
        expect(Color.fromCssColorString("hsl(240, 100%, 50%)")).toEqual(
            Color.BLUE,
        );
    ...
    it("fromCssColorString supports the hsla() format", function () {
        ...
        expect(
            Color.fromCssColorString("hsla(220, 60%, 50%, 0.6)"),
        ).toEqualEpsilon(new Color(0.2, 0.4, 0.8, 0.6), CesiumMath.EPSILON15);
    });
    ...
    it("fromCssColorString understands the color string even with any number of unnecessary leading, trailing or middle spaces", function () {
        expect(Color.fromCssColorString(" rgb( 0, 0, 255)")).toEqual(
            Color.BLUE,
        );
