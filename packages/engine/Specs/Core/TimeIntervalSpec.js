...
describe("Core/TimeInterval", function () {
    ...
    it("contains works for a non-empty interval.", function () {
        ...
        expect(
            TimeInterval.contains(interval, new JulianDate(2451545.5)),
        ).toEqual(true);
        expect(
            TimeInterval.contains(interval, new JulianDate(2451546.5)),
        ).toEqual(false);
    });

    it("contains works for an empty interval.", function () {
        expect(
            TimeInterval.contains(TimeInterval.EMPTY, new JulianDate()),
        ).toEqual(false);
    });
    ...
    it("contains returns true at start and stop times of a closed interval", function () {
        ...
        expect(
            TimeInterval.contains(interval, new JulianDate(2451545)),
        ).toEqual(true);
        expect(
            TimeInterval.contains(interval, new JulianDate(2451546)),
        ).toEqual(true);
    });
    ...
    it("equals and equalsEpsilon work", function () {
        ...
        expect(TimeInterval.equalsEpsilon(undefined, undefined, 0)).toEqual(
            true,
        );
