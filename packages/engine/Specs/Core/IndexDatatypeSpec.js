...
describe("Core/IndexDatatype", function () {
    it("validate validates input", function () {
        expect(IndexDatatype.validate(IndexDatatype.UNSIGNED_SHORT)).toEqual(
            true,
        );
    ...
    it("getSizeInBytes returns size", function () {
        expect(
            IndexDatatype.getSizeInBytes(IndexDatatype.UNSIGNED_BYTE),
        ).toEqual(Uint8Array.BYTES_PER_ELEMENT);
        expect(
            IndexDatatype.getSizeInBytes(IndexDatatype.UNSIGNED_SHORT),
        ).toEqual(Uint16Array.BYTES_PER_ELEMENT);
        expect(
            IndexDatatype.getSizeInBytes(IndexDatatype.UNSIGNED_INT),
        ).toEqual(Uint32Array.BYTES_PER_ELEMENT);
    });
