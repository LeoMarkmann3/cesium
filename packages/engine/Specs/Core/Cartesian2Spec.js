...
describe("Core/Cartesian2", function () {
    ...
    it("minimumByComponent with a result parameter", function () {
        ...
        const result = new Cartesian2();
        const returnedResult = Cartesian2.minimumByComponent(
            first,
            second,
            result,
        );
    ...
    it("maximumByComponent with a result parameter", function () {
        ...
        const result = new Cartesian2();
        const returnedResult = Cartesian2.maximumByComponent(
            first,
            second,
            result,
        );
    ...
    it("multiplyComponents works with a result parameter", function () {
        ...
        const returnedResult = Cartesian2.multiplyComponents(
            left,
            right,
            result,
        );
    ...
    it("equalsEpsilon", function () {
        ...
        expect(Cartesian2.equalsEpsilon(undefined, cartesian, 1)).toEqual(
            false,
        );
    });
