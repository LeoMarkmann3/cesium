...
describe("Core/BoundingRectangle", function () {
    ...
    it("equals", function () {
        const rectangle = new BoundingRectangle(1.0, 2.0, 3.0, 4.0);
        expect(
            rectangle.equals(new BoundingRectangle(1.0, 2.0, 3.0, 4.0)),
        ).toEqual(true);
        expect(
            rectangle.equals(new BoundingRectangle(5.0, 2.0, 3.0, 4.0)),
        ).toEqual(false);
        expect(
            rectangle.equals(new BoundingRectangle(1.0, 6.0, 3.0, 4.0)),
        ).toEqual(false);
        expect(
            rectangle.equals(new BoundingRectangle(1.0, 2.0, 7.0, 4.0)),
        ).toEqual(false);
        expect(
            rectangle.equals(new BoundingRectangle(1.0, 2.0, 3.0, 8.0)),
        ).toEqual(false);
    ...
    it("expand works with a result parameter", function () {
        ...
        const expected = new BoundingRectangle(2.0, -1.0, 1.0, 2.0);
        const result = new BoundingRectangle();
        const returnedResult = BoundingRectangle.expand(
            rectangle,
            point,
            result,
        );
