...
describe("Core/TimeIntervalCollection", function () {
    ...
    function checkIntervals(
        ...
        for (let i = 0; i < length; ++i) {
            ...
            expect(JulianDate.compare(interval.start, julianDates[i])).toEqual(
                0,
            );
            expect(
                JulianDate.compare(interval.stop, julianDates[i + 1]),
            ).toEqual(0);
            expect(interval.isStartIncluded).toBe(
                i === 0 ? isStartIncluded : true,
            );
    ...
    it("addInterval and findIntervalContainingDate work when using overlapping intervals", function () {
        ...
        expect(
            intervals.findIntervalContainingDate(interval1.start).data,
        ).toEqual(1);
        expect(
            intervals.findIntervalContainingDate(interval1.stop).data,
        ).toEqual(1);
        ...
        expect(
            intervals.findIntervalContainingDate(interval2.stop).data,
        ).toEqual(2);
        ...
        expect(
            intervals.findIntervalContainingDate(interval2.start).data,
        ).toEqual(3);
        expect(
            intervals.findIntervalContainingDate(interval2.stop).data,
        ).toEqual(3);
        expect(
            intervals.findIntervalContainingDate(interval3.start).data,
        ).toEqual(3);
        expect(
            intervals.findIntervalContainingDate(interval3.stop).data,
        ).toEqual(3);
    });
    ...
    it("findDataForIntervalContainingDate works", function () {
        ...
        expect(
            intervals.findDataForIntervalContainingDate(interval1.stop),
        ).toEqual(1);
        ...
        expect(
            intervals.findDataForIntervalContainingDate(interval2.stop),
        ).toEqual(2);
    ...
    it("removeInterval works correctly", function () {
        ...
        // After last
        expect(
            intervals.removeInterval(createTimeInterval(50.0, 60.0)),
        ).toEqual(false);
        expect(intervals.length).toEqual(2);

        // Inside hole
        expect(
            intervals.removeInterval(createTimeInterval(22.0, 28.0)),
        ).toEqual(false);
        expect(intervals.length).toEqual(2);
        ...
        // From end
        expect(
            intervals.removeInterval(createTimeInterval(35.0, 45.0)),
        ).toEqual(true);
        expect(intervals.length).toEqual(2);
        ...
        expect(
            intervals.removeInterval(createTimeInterval(12.0, 18.0)),
        ).toEqual(true);
        expect(intervals.length).toEqual(3);
        ...
        expect(
            intervals.removeInterval(createTimeInterval(25.0, 46.0)),
        ).toEqual(true);
        expect(intervals.length).toEqual(2);
        ...
        expect(
            intervals.removeInterval(createTimeInterval(25.0, 40.0)),
        ).toEqual(true);
        expect(intervals.length).toEqual(2);
        expect(JulianDate.totalDays(intervals.get(0).stop)).toEqual(20.0);
        ...
        expect(
            intervals.removeInterval(
                createTimeInterval(25.0, 40.0, true, false),
            ),
        ).toEqual(true);
        expect(intervals.length).toEqual(3);
        expect(JulianDate.totalDays(intervals.get(0).stop)).toEqual(20.0);
        ...
        expect(
            intervals.removeInterval(
                createTimeInterval(20.0, 30.0, false, true),
            ),
        ).toEqual(false);
        expect(intervals.length).toEqual(1);
        expect(JulianDate.totalDays(intervals.get(0).start)).toEqual(10.0);
        ...
        expect(
            intervals.removeInterval(
                createTimeInterval(0.0, 20.0, false, false),
            ),
        ).toEqual(true);
        expect(intervals.length).toEqual(2);
        ...
        function addIntervals(collection, specs) {
            specs.forEach(function (spec) {
                collection.addInterval(
                    intervalFromSeconds(spec.sec, spec.data),
                );
            });
        }
    ...
    it("fromIso8601 handles leadingInterval option", function () {
        ...
        expect(
            JulianDate.compare(leading.start, Iso8601.MINIMUM_VALUE),
        ).toEqual(0);
    ...
    it("fromIso8601 handles trailingInterval option", function () {
        ...
        expect(
            JulianDate.compare(
                trailing.start,
                julianDates[iso8601Dates.length - 1],
            ),
        ).toEqual(0);
        expect(
            JulianDate.compare(trailing.stop, Iso8601.MAXIMUM_VALUE),
        ).toEqual(0);
