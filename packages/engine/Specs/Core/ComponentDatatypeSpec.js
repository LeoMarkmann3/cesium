...
describe("Core/ComponentDatatype", function () {
    ...
    it("validate works", function () {
        ...
        expect(
            ComponentDatatype.validate(ComponentDatatype.UNSIGNED_BYTE),
        ).toBe(true);
        expect(ComponentDatatype.validate(ComponentDatatype.SHORT)).toBe(true);
        expect(
            ComponentDatatype.validate(ComponentDatatype.UNSIGNED_SHORT),
        ).toBe(true);
    ...
    it("fromName works", function () {
        expect(ComponentDatatype.fromName("BYTE")).toEqual(
            ComponentDatatype.BYTE,
        );
        ...
        expect(ComponentDatatype.fromName("INT")).toEqual(
            ComponentDatatype.INT,
        );
