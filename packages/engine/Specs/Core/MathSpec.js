...
describe("Core/Math", function () {
    ...
    it("negativePiToPi", function () {
        ...
        expect(CesiumMath.negativePiToPi(-Math.PI)).toEqual(-Math.PI);
        expect(CesiumMath.negativePiToPi(+Math.PI - 1.0)).toEqual(
            +Math.PI - 1.0,
        );
        expect(CesiumMath.negativePiToPi(-Math.PI + 1.0)).toEqual(
            -Math.PI + 1.0,
        );
        expect(CesiumMath.negativePiToPi(+Math.PI - 0.1)).toEqual(
            +Math.PI - 0.1,
        );
        expect(CesiumMath.negativePiToPi(-Math.PI + 0.1)).toEqual(
            -Math.PI + 0.1,
    ...
    it("equalsEpsilon", function () {
        ...
        expect(CesiumMath.equalsEpsilon(3000000.0, 3000000.0, 0.0)).toEqual(
            true,
        );
        expect(
