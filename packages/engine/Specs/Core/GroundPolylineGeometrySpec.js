...
describe("Core/GroundPolylineGeometry", function () {
    ...
    it("computes positions and additional attributes for polylines", function () {
        ...
        const texcoordNormalization2D =
            geometry.attributes.texcoordNormalization2D;
        ...
        startPosition3D.x =
            startHiAndForwardOffsetX.values[0] +
            startLoAndForwardOffsetY.values[0];
        startPosition3D.y =
            startHiAndForwardOffsetX.values[1] +
            startLoAndForwardOffsetY.values[1];
        startPosition3D.z =
            startHiAndForwardOffsetX.values[2] +
            startLoAndForwardOffsetY.values[2];
        ...
        endPosition3D.x =
            startPosition3D.x + startHiAndForwardOffsetX.values[3];
        endPosition3D.y =
            startPosition3D.y + startLoAndForwardOffsetY.values[3];
        endPosition3D.z =
    ...
    it("breaks miters for tight turns", function () {
        ...
        geometry = GroundPolylineGeometry.createGeometry(
            groundPolylineGeometry,
        );
    ...
    it("interpolates long polyline segments for rhumb lines", function () {
        ...
        expect(rhumbGeometry.attributes.position.values.length).toEqual(
            2424 + 24,
        );
    });
