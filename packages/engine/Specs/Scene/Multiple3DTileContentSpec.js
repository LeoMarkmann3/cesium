    ...
    function () {
        ...
        function expectRenderMultipleContents(tileset) {
            expect(scene).toPickAndCall(function (result) {
                ...
                pickedBuilding.color = Color.clone(
                    Color.YELLOW,
                    pickedBuilding.color,
                );
                ...
                pickedInstance.color = Color.clone(
                    Color.GREEN,
                    pickedInstance.color,
                );
        ...
        describe("metadata", function () {
            ...
            it("initializes group metadata for inner contents", function () {
                return Cesium3DTilesTester.loadTileset(
                    ...
                    expect(groupMetadata.getProperty("isInstanced")).toBe(
                        false,
                    );
            ...
            it("initializes explicit content metadata for inner contents", function () {
                return Cesium3DTilesTester.loadTileset(
                    ...
                    expect(
                        batchedMetadata.getProperty("highlightColor"),
                    ).toEqual(new Cartesian3(0, 0, 255));
                    expect(batchedMetadata.getProperty("author")).toEqual(
                        "Cesium",
                    );
                    ...
                    expect(
                        instancedMetadata.getProperty("numberOfInstances"),
                    ).toEqual(50);
