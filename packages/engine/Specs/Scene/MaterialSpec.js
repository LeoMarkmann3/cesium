...
describe(
    ...
    function () {
        ...
        it("creates material with custom texture filter", async function () {
            ...
            materialLinear.minificationFilter =
                TextureMinificationFilter.LINEAR;
            materialLinear.magnificationFilter =
                TextureMagnificationFilter.LINEAR;

            const materialNearest = await Material.fromTypeAsync("DiffuseMap", {
                image: "./Data/Images/BlueOverRed.png",
            });
            materialNearest.minificationFilter =
                TextureMinificationFilter.NEAREST;
            materialNearest.magnificationFilter =
        ...
        it("destroys sub-materials", function () {
            ...
            material.materials.diffuseMap.uniforms.image =
            ...
            return pollToPromise(function () {
                const result =
                    material.materials.diffuseMap._loadedImages.length !== 0;
                scene.renderForSpecs();
                return result;
            }).then(function () {
        ...
        it("throws when loaded async and image loading fails", async function () {
            spyOn(Resource.prototype, "fetchImage").and.callFake(function () {
                return Promise.reject(
                    new DeveloperError("Image loading failed"),
                );
            });
