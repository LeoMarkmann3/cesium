...
describe("Scene/VoxelShapeType", function () {
    ...
    it("getShapeConstructor works", function () {
        ...
        expect(
            VoxelShapeType.getShapeConstructor(VoxelShapeType.ELLIPSOID),
        ).toBe(VoxelEllipsoidShape);
        expect(
            VoxelShapeType.getShapeConstructor(VoxelShapeType.CYLINDER),
        ).toBe(VoxelCylinderShape);
    });
