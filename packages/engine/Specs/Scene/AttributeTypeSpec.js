...
describe("Scene/AttributeType", function () {
    ...
    it("getGlslType works", function () {
        expect(AttributeType.getGlslType(AttributeType.SCALAR)).toEqual(
            "float",
        );
    ...
    it("getNumberOfComponents works", function () {
        expect(AttributeType.getNumberOfComponents(AttributeType.SCALAR)).toBe(
            1,
        );
        ...
        expect(AttributeType.getNumberOfComponents(AttributeType.MAT4)).toBe(
            16,
        );
    });
    ...
    it("getAttributeLocationCount works", function () {
        expect(
            AttributeType.getAttributeLocationCount(AttributeType.SCALAR),
        ).toBe(1);
        expect(
            AttributeType.getAttributeLocationCount(AttributeType.VEC2),
        ).toBe(1);
        expect(
            AttributeType.getAttributeLocationCount(AttributeType.VEC3),
        ).toBe(1);
        expect(
            AttributeType.getAttributeLocationCount(AttributeType.VEC4),
        ).toBe(1);
        expect(
            AttributeType.getAttributeLocationCount(AttributeType.MAT2),
        ).toBe(2);
        expect(
            AttributeType.getAttributeLocationCount(AttributeType.MAT3),
        ).toBe(3);
        expect(
            AttributeType.getAttributeLocationCount(AttributeType.MAT4),
        ).toBe(4);
    });
