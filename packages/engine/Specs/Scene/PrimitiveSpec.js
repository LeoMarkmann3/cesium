...
describe(
    ...
    function () {
        ...
        it("get common per instance attributes", function () {
            rectangleInstance2.attributes.not_used =
        ...
        it("can mix valid and invalid geometry", function () {
            ...
            return pollToPromise(function () {
                ...
                expect(
                    primitive.getGeometryInstanceAttributes("rectangle2")
                        .boundingSphere,
                ).toBeDefined();
                expect(
                    primitive.getGeometryInstanceAttributes("invalid")
                        .boundingSphere,
                ).not.toBeDefined();
            });
        });
