...
describe(
    ...
    function () {
        ...
        it("processes POSITION, NORMAL, TEXCOORD and TANGENT attributes from primitive", function () {
            return loadGltf(boomBoxSpecularGlossiness).then(
                function (gltfLoader) {
                    ...
                    expect(texCoord0Attribute.vertexBuffer).toBeDefined();
                    expect(texCoord0Attribute.componentsPerAttribute).toEqual(
                        2,
                    );
                    expect(texCoord0Attribute.componentDatatype).toEqual(
                        ComponentDatatype.FLOAT,
        ...
        it("processes model with matrix attributes", function () {
            return loadGltf(boxTexturedWithPropertyAttributes).then(
                function (gltfLoader) {
                    ...
                    expect(warpMatrixAttribute.componentsPerAttribute).toEqual(
                        2,
                    );
                    ...
                    expect(
                        warpMatrixAttributePart2.componentsPerAttribute,
                    ).toEqual(2);
                    ...
                    expect(
                        temperaturesAttribute.componentsPerAttribute,
                    ).toEqual(2);
        ...
        it("processes POSITION attribute for instanced model for 2D", function () {
            return loadGltf(boxInstancedTranslationUrl).then(
                function (gltfLoader) {
                    const components = gltfLoader.components;
