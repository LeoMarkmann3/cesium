...
describe(
    ...
    function () {
        ...
        const geoJsonPointUrl =
            "./Data/Cesium3DTiles/GeoJson/Point/point.geojson";
        ...
        function testLoader(url, expected) {
            return loadGeoJson(url).then(function (loader) {
                ...
                if (primitive.primitiveType === PrimitiveType.LINES) {
                    ...
                    expect(indices.buffer.sizeInBytes).toBe(
                ...
                expect(featureIdAccessor.featureCount).toEqual(
                ...
                if (expected.hasProperties && expected.featureCount === 1) {
                    ...
                    expected.hasProperties &&
                    expected.featureCount === 2
                ) {
