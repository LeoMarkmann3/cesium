...
describe(
    ...
    function () {
        ...
        it("throws for undefined nodeRenderResources", function () {
            expect(function () {
                return new PrimitiveRenderResources(
                    undefined,
                    runtimePrimitive,
                );
        ...
        it("constructs", function () {
            ...
            expect(primitiveResources.primitiveType).toBe(
                PrimitiveType.TRIANGLES,
            );
            expect(primitiveResources.positionMin).toEqual(
                new Cartesian3(-1, -1, -1),
            );
            expect(primitiveResources.positionMax).toEqual(
                new Cartesian3(1, 1, 1),
            );
        ...
        it("inherits from node render resources", function () {
            ...
            nodeResources.shaderBuilder.addDefine("NODE");
            nodeResources.renderStateOptions.blending =
