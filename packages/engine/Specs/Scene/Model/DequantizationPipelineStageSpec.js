    ...
    function () {
        ...
        it("adds a dequantization function", function () {
            ...
            return loadGltf(boxWithLines).then(function (gltfLoader) {
                ...
                ShaderBuilderTester.expectHasFragmentFunctionIds(
                    shaderBuilder,
                    [],
                );
            });
        ...
        it("adds dequantization uniforms", function () {
            ...
            return loadGltf(milkTruck).then(function (gltfLoader) {
                ...
                const uniformValues = {
                    ...
                    positionOffset:
                        uniformMap.model_quantizedVolumeOffset_positionMC(),
                    positionStepSize:
                        uniformMap.model_quantizedVolumeStepSize_positionMC(),
                    texCoordOffset:
                        uniformMap.model_quantizedVolumeOffset_texCoord_0(),
                    texCoordStepSize:
                ...
                expect(uniformValues).toEqualEpsilon(
                    expected,
            ...
            return loadGltf(boxDracoRGBColors).then(function (gltfLoader) {
                ...
                const uniformValues = {
                    ...
                    positionStepSize:
                        uniformMap.model_quantizedVolumeStepSize_positionMC(),
                    colorOffset:
                        uniformMap.model_quantizedVolumeOffset_color_0(),
                    colorStepSize:
                        uniformMap.model_quantizedVolumeStepSize_color_0(),
                };
