...
describe("Scene/Model/CustomShader", function () {
    ...
    it("defines uniforms", function () {
        ...
        expect(customShader.uniformMap.u_offset()).toBe(
            uniforms.u_offset.value,
        );
    });
    ...
    it("detects input variables in the shader text", function () {
        ...
        expect(customShader.usedVariablesVertex).toEqual(
            expectedVertexVariables,
        );
            ...
            it("can change texture uniform value", function () {
                ...
                return waitForTextureLoad(customShader, "u_testTexture").then(
                    function (blueTexture) {
                        ...
                        return waitForTextureLoad(
                            customShader,
                            "u_testTexture",
                        ).then(function (greenTexture) {
                            expect(
                                customShader.uniformMap.u_testTexture(),
                            ).toBe(greenTexture);
