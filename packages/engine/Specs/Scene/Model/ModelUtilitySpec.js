...
describe("Scene/Model/ModelUtility", function () {
    it("getNodeTransform works when node has a matrix", function () {
        ...
        expect(Matrix4.equals(computedTransform, Matrix4.IDENTITY)).toEqual(
            true,
        );
    });
    ...
    it("getFeatureIdsByLabel gets feature ID sets by positional label", function () {
        ...
        expect(
            ModelUtility.getFeatureIdsByLabel(featureIds, "featureId_0"),
        ).toBe(featureIds[0]);
        expect(
            ModelUtility.getFeatureIdsByLabel(featureIds, "featureId_1"),
        ).toBe(featureIds[1]);
    });
