...
describe("Scene/Model/ModelPrimitiveImagery", function () {
    ...
    it("_createImageryTexCoordAttributes computes the attributes", async function () {
        ...
        const actualTexCoordAttributes =
            modelPrimitiveImagery._createImageryTexCoordAttributes(
                uniqueProjections,
            );
    ...
    it("reference counting for imagery works", async function () {
        ...
        // count by default...
        const imagery0 = imageryLayer.getImageryFromCache(
            5592405,
            12703007,
            25,
        );
        const imagery1 = imageryLayer.getImageryFromCache(
            5592405,
            12703008,
            25,
        );
        const imagery2 = imageryLayer.getImageryFromCache(
            5592406,
            12703007,
            25,
        );
        const imagery3 = imageryLayer.getImageryFromCache(
            5592406,
            12703008,
            25,
        );
