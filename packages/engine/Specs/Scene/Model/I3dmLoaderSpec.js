...
describe(
    ...
    function () {
            ...
            for (let i = 0; i < components.nodes.length; i++) {
                ...
                if (node.primitives.length > 0) {
                    ...
                    for (let j = 0; j < attributesLength; j++) {
                        ...
                        expect(
                            expectedSemantics.indexOf(attribute.semantic) > -1,
                        ).toEqual(true);
        ...
        it("loads InstancedWithBatchTableBinaryUrl", function () {
            return loadI3dm(instancedWithBatchTableBinaryUrl).then(
                function (loader) {
                    verifyInstances(
                        loader,
                        [
        ...
        it("loads InstancedWithoutBatchTableUrl", function () {
            return loadI3dm(instancedWithoutBatchTableUrl).then(
                function (loader) {
                    verifyInstances(
                        loader,
                        [
        ...
        it("loads InstancedOct32POrientationUrl", function () {
            return loadI3dm(instancedOct32POrientationUrl).then(
                function (loader) {
                    verifyInstances(
                        loader,
                        [
        ...
        it("loads InstancedScaleNonUniformUrl", function () {
            return loadI3dm(instancedScaleNonUniformUrl).then(
                function (loader) {
                    verifyInstances(
                        loader,
                        [
