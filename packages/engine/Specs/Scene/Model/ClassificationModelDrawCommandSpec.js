...
describe(
    ...
    function () {
        ...
        function createDrawCommand(options) {
            ...
            options.renderState =
                options.renderState ?? RenderState.fromCache();
        ...
        function verifyColorCommand(command, expectedPass, testForPicking) {
            ...
            if (testForPicking) {
                ...
                expect(renderState.blending).toEqual(
                    expectedColorCommandBlending,
                );
            }
        }
        ...
        describe("pushCommands", function () {
            ...
            it("pushCommands derives ignore show commands for 3D Tiles", function () {
                ...
                const commandListIgnoreShow =
                    drawCommand._commandListIgnoreShow;
                ...
                for (let i = 0; i < length; i++) {
                    ...
                    expect(commandList[indexOffset + i]).toBe(
                        ignoreShowCommand,
                    );
