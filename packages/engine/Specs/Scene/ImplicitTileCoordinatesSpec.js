...
describe("Scene/ImplicitTileCoordinates", function () {
    ...
    it("getAncestorCoordinates throws with invalid inputs", function () {
        // undefined input
        expect(function () {
            return quadtreeCoordinates(0, 0, 0).getAncestorCoordinates(
                undefined,
            );
        }).toThrowDeveloperError();
    ...
    it("getChildCoordinates works as expected for quadree", function () {
        ...
        expect(
            coordinates
                .getChildCoordinates(0)
                .isEqual(quadtreeCoordinates(2, 0, 0)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(1)
                .isEqual(quadtreeCoordinates(2, 1, 0)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(2)
                .isEqual(quadtreeCoordinates(2, 0, 1)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(3)
                .isEqual(quadtreeCoordinates(2, 1, 1)),
        ).toEqual(true);
    });
    ...
    it("getChildCoordinates works as expected for octree", function () {
        ...
        expect(
            coordinates
                .getChildCoordinates(0)
                .isEqual(octreeCoordinates(2, 0, 2, 2)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(1)
                .isEqual(octreeCoordinates(2, 1, 2, 2)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(2)
                .isEqual(octreeCoordinates(2, 0, 3, 2)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(3)
                .isEqual(octreeCoordinates(2, 1, 3, 2)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(4)
                .isEqual(octreeCoordinates(2, 0, 2, 3)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(5)
                .isEqual(octreeCoordinates(2, 1, 2, 3)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(6)
                .isEqual(octreeCoordinates(2, 0, 3, 3)),
        ).toEqual(true);

        expect(
            coordinates
                .getChildCoordinates(7)
                .isEqual(octreeCoordinates(2, 1, 3, 3)),
        ).toEqual(true);
    });
    ...
    it("isAncestor works as expected for quadtree", function () {
        ...
        expect(
            quadtreeCoordinates(0, 0, 0).isAncestor(
                quadtreeCoordinates(0, 0, 0),
            ),
        ).toEqual(false);
        ...
        expect(
            quadtreeCoordinates(1, 0, 0).isAncestor(
                quadtreeCoordinates(2, 3, 3),
            ),
        ).toEqual(false);
    });
    ...
    it("isAncestor works as expected for octree", function () {
        // cannot be ancestor of itself
        expect(
            octreeCoordinates(0, 0, 0, 0).isAncestor(
                octreeCoordinates(0, 0, 0, 0),
            ),
        ).toEqual(false);
        ...
        // higher up in the tree but not an ancestor
        expect(
            octreeCoordinates(1, 0, 0, 0).isAncestor(
                octreeCoordinates(2, 3, 3, 3),
            ),
        ).toEqual(false);
    });
    ...
    it("isEqual works as expected for quadtree", function () {
        // same
        expect(
            octreeCoordinates(0, 0, 0, 0).isEqual(
                octreeCoordinates(0, 0, 0, 0),
            ),
        ).toEqual(true);
        ...
        // different X
        expect(
            octreeCoordinates(1, 0, 0, 0).isEqual(
                octreeCoordinates(1, 1, 0, 0),
            ),
        ).toEqual(false);
    ...
    it("isImplicitTilesetRoot works as expected", function () {
        expect(quadtreeCoordinates(0, 0, 0).isImplicitTilesetRoot()).toEqual(
            true,
        );
        expect(quadtreeCoordinates(1, 0, 0).isImplicitTilesetRoot()).toEqual(
            false,
        );
        expect(quadtreeCoordinates(2, 0, 0).isImplicitTilesetRoot()).toEqual(
            false,
        );
    });
