...
describe("Scene/UrlTemplateImageryProvider", function () {
    ...
    it("conforms to ImageryProvider interface", function () {
        expect(UrlTemplateImageryProvider).toConformToInterface(
            ImageryProvider,
        );
    });
        ...
        spyOn(Resource._Implementations, "createImage").and.callFake(
            function (request, crossOrigin, deferred) {
                expect(request.url).toEqual(
                    "made/up/tms/server/2/3/2/1/4/3.PNG",
                );
    ...
    it("uses custom tags", function () {
        ...
        spyOn(Resource._Implementations, "createImage").and.callFake(
            function (request, crossOrigin, deferred) {
                expect(request.url).toEqual(
                    "made/up/tms/server/foo/bar/2/1/3.PNG",
                );
    ...
    describe("pickFeatures", function () {
        ...
        it("does not return undefined when enablePickFeatures is subsequently set to true", function () {
            ...
            expect(
                provider.pickFeatures(0, 0, 0, 0.0, 0.0),
            ).not.toBeUndefined();
        });
