    ...
    function () {
        ...
        describe("CoplanarPolygonGeometry", function () {
            ...
            beforeAll(function () {
                instance = new GeometryInstance({
                    geometry: CoplanarPolygonGeometry.fromPositions({
                        positions: Cartesian3.fromDegreesArrayHeights([
                            71.0, -10.0, 0.0, 70.0, 0.0, 20000.0, 69.0, 0.0,
                            20000.0, 68.0, -10.0, 0.0,
                        ]),
                        vertexFormat:
                            PerInstanceColorAppearance.FLAT_VERTEX_FORMAT,
                    }),
                ...
                geometry = CoplanarPolygonGeometry.createGeometry(
                    instance.geometry,
                );
                geometry.boundingSphereWC = BoundingSphere.transform(
                    geometry.boundingSphere,
        ...
        describe(
            ...
            function () {
                ...
                beforeAll(function () {
                    ...
                    geometry = EllipseGeometry.createGeometry(
                        instance.geometry,
                    );
                    geometry.boundingSphereWC = BoundingSphere.transform(
                        geometry.boundingSphere,
        ...
        describe(
            ...
            function () {
                ...
                beforeAll(function () {
                    ...
                    geometry = RectangleGeometry.createGeometry(
                        instance.geometry,
                    );
                    geometry.boundingSphereWC = BoundingSphere.transform(
                        geometry.boundingSphere,
                    ...
                    function afterView() {
                        ...
                        scene.camera.lookAtTransform(
                            ...
                            new Cartesian3(
                                0.0,
                                0.0,
                                geometry.boundingSphereWC.radius,
                            ),
                        );
                        scene.camera.rotateDown(CesiumMath.PI);
                    }
                ...
                it("hierarchy", function () {
                    const hierarchy = new GeometryInstance({
                        geometry: new PolygonGeometry({
                            ...
                            polygonHierarchy: {
                                positions: Cartesian3.fromDegreesArray([
                                    -109.0, 30.0, -95.0, 30.0, -95.0, 40.0,
                                    -109.0, 40.0,
                                ]),
                                holes: [
                                    {
                                        positions: Cartesian3.fromDegreesArray([
                                            -107.0, 31.0, -107.0, 39.0, -97.0,
                                            39.0, -97.0, 31.0,
                                        ]),
                                        holes: [
                                            {
                ...
                it("renders with correct winding order in southern hemisphere", function () {
                    const instance = new GeometryInstance({
                        geometry: PolygonGeometry.fromPositions({
                            ...
                            ellipsoid: ellipsoid,
                            positions: Cartesian3.fromDegreesArrayHeights([
                                -108.0, -25.0, 500000, -100.0, -25.0, 500000,
                                -100.0, -30.0, 500000, -108.0, -30.0, 500000,
                            ]),
                    ...
                    function afterView() {
                        ...
                        scene.camera.moveForward(
                            geometry.boundingSphereWC.radius * 0.75,
                        );
                    }
                    render3D(instance, afterView);
                });
        ...
        describe(
            ...
            function () {
                ...
                beforeAll(function () {
                    ...
                    geometry = PolylineVolumeGeometry.createGeometry(
                        instance.geometry,
                    );
                    geometry.boundingSphereWC = BoundingSphere.transform(
                        geometry.boundingSphere,
        ...
        describe(
            ...
            function () {
                ...
                beforeAll(function () {
                    ...
                    geometry = SimplePolylineGeometry.createGeometry(
                        instance.geometry,
                    );
                    geometry.boundingSphereWC = BoundingSphere.transform(
                        geometry.boundingSphere,
