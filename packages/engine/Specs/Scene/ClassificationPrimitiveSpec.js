...
describe(
    ...
    function () {
        ...
        it("renders batched instances", function () {
            ...
            verifyClassificationPrimitiveRender(
                primitive,
                boxColorAttribute.value,
            );
        });
        ...
        it("renders with invert classification and an opaque color", function () {
            ...
            boxInstance.attributes.show = new ShowGeometryInstanceAttribute(
                true,
            );
        ...
        it("drill picking", function () {
            ...
            expect(scene).toDrillPickAndCall(function (pickedObjects) {
                ...
                expect(pickedObjects[1].primitive).toEqual(
                    globePrimitive._primitive,
                );
                expect(pickedObjects[2].primitive).toEqual(
                    tilesetPrimitive._primitive,
                );
            });
        });
