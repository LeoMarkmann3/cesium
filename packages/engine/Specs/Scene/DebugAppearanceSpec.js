...
describe(
    ...
    function () {
        ...
        it("default construct with normal, bitangent, or tangent attribute name", function () {
            ...
            expect(a.vertexShaderSource.indexOf("v_normal")).toBeGreaterThan(
                -1,
            );

            expect(a.fragmentShaderSource).toBeDefined();
            expect(a.fragmentShaderSource.indexOf("v_normal")).toBeGreaterThan(
                -1,
            );
        ...
        it("debug appearance with float attribute name", function () {
            ...
            expect(a.vertexShaderSource).toBeDefined();
            expect(a.vertexShaderSource.indexOf("rotation")).toBeGreaterThan(
                -1,
            );
            expect(a.vertexShaderSource.indexOf("v_rotation")).toBeGreaterThan(
                -1,
            );

            expect(a.fragmentShaderSource).toBeDefined();
            expect(
                a.fragmentShaderSource.indexOf("v_rotation"),
            ).toBeGreaterThan(-1);
        ...
        it("debug appearance with vec4 attribute name", function () {
            ...
            expect(a.vertexShaderSource).toBeDefined();
            expect(a.vertexShaderSource.indexOf("quaternion")).toBeGreaterThan(
                -1,
            );
            expect(
                a.vertexShaderSource.indexOf("v_quaternion"),
            ).toBeGreaterThan(-1);

            expect(a.fragmentShaderSource).toBeDefined();
            expect(
                a.fragmentShaderSource.indexOf("v_quaternion"),
            ).toBeGreaterThan(-1);
