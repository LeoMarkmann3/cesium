...
describe("Scene/MetadataPicking", function () {
    describe("decodeRawMetadataValue", function () {
        it("throws for invalid component type", function () {
            expect(function () {
                ...
                const index = 0;
                MetadataPicking.decodeRawMetadataValue(
                    componentType,
                    dataView,
                    index,
                );
    ...
    describe("decodeRawMetadataValues", function () {
        it("throws for invalid component type", function () {
            expect(function () {
                ...
                MetadataPicking.decodeRawMetadataValues(
                    classProperty,
                    rawPixelValues,
                );
            }).toThrowError();
    ...
    describe("convertToObjectType", function () {
        ...
        it("returns SCALAR, STRING, BOOLEAN, and ENUM types (and arrays thereof) unmodified", function () {
            ...
            const value1a = MetadataPicking.convertToObjectType(
                MetadataType.STRING,
                ["Value0", "Value1"],
            );
            const value2a = MetadataPicking.convertToObjectType(
                MetadataType.SCALAR,
                [true, false],
            );
            const value3a = MetadataPicking.convertToObjectType(
                MetadataType.ENUM,
                ["VALUE_A", "VALUE_B"],
            );
    ...
    describe("convertFromObjectType", function () {
        ...
        it("returns SCALAR, STRING, BOOLEAN, and ENUM types (and arrays thereof) unmodified", function () {
            ...
            const value3a = MetadataPicking.convertFromObjectType(
                MetadataType.ENUM,
                ["VALUE_A", "VALUE_B"],
            );
