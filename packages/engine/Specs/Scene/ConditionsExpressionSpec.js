...
describe("Scene/ConditionsExpression", function () {
    ...
    it("evaluates conditional", function () {
        const expression = new ConditionsExpression(jsonExp);
        expect(expression.evaluateColor(new MockFeature(101))).toEqual(
            Color.BLUE,
        );
        expect(expression.evaluateColor(new MockFeature(52))).toEqual(
            Color.RED,
        );
        expect(expression.evaluateColor(new MockFeature(3))).toEqual(
            Color.LIME,
        );
    });
