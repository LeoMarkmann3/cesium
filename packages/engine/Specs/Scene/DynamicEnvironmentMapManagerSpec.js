    ...
    describe(
        ...
        () => {
            ...
            it("creates environment map and spherical harmonics at surface in Philadelphia with static lighting", async function () {
                ...
                ).toEqual(TextureMinificationFilter.LINEAR_MIPMAP_LINEAR); // Has mipmaps for specular maps
                ...
                expect(manager.sphericalHarmonicCoefficients[4].x).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[4].y).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[4].z).toBeLessThan(
                    0.0,
                );

                expect(
                    manager.sphericalHarmonicCoefficients[5].x,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[5].y,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[5].z,
                ).toBeGreaterThan(0.0);

                expect(manager.sphericalHarmonicCoefficients[6].x).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[6].y).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[6].z).toBeLessThan(
                    0.0,
                );

                expect(
                    manager.sphericalHarmonicCoefficients[7].x,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[7].y,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[7].z,
                ).toBeGreaterThan(0.0);

                expect(manager.sphericalHarmonicCoefficients[8].x).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[8].y).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[8].z).toBeLessThan(
                    0.0,
                );
            });
            ...
            it("creates environment map and spherical harmonics at altitude in Philadelphia with static lighting", async function () {
                ...
                expect(manager.sphericalHarmonicCoefficients[5].x).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[5].y).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[5].z).toBeLessThan(
                    0.0,
                );

                expect(
                    manager.sphericalHarmonicCoefficients[6].x,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[6].y,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[6].z,
                ).toBeGreaterThan(0.0);

                expect(manager.sphericalHarmonicCoefficients[7].x).toBeLessThan(
                    0.0,
                );
                expect(
                    manager.sphericalHarmonicCoefficients[7].y,
                ...
                expect(
                    manager.sphericalHarmonicCoefficients[8].x,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[8].y,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[8].z,
                ).toBeGreaterThan(0.0);
            });
            ...
            it("creates environment map and spherical harmonics above Earth's atmosphere with static lighting", async function () {
                ...
                expect(
                    manager.sphericalHarmonicCoefficients[4].x,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[4].y,
                ).toBeGreaterThan(0.0);
                expect(
                    manager.sphericalHarmonicCoefficients[4].z,
                ).toBeGreaterThan(0.0);
                ...
                expect(manager.sphericalHarmonicCoefficients[7].y).toBeLessThan(
                    0.0,
                );
                expect(manager.sphericalHarmonicCoefficients[7].z).toBeLessThan(
                    0.0,
                );
            ...
            it("lighting uses ground color value", async function () {
                ...
                expect(
                    manager.sphericalHarmonicCoefficients[4].y,
                ).toEqualEpsilon(0.0, CesiumMath.EPSILON2);
                expect(
                    manager.sphericalHarmonicCoefficients[4].z,
                ).toEqualEpsilon(0.0, CesiumMath.EPSILON2);
