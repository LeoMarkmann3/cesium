...
describe("Scene/ScreenSpaceCameraController", function () {
    ...
    function setUp2D() {
        ...
        frustum.top =
            frustum.right * (canvas.clientHeight / canvas.clientWidth);
    ...
    it("rotates in Columbus view", function () {
        ...
        expect(
            Cartesian3.dot(camera.direction, Cartesian3.UNIT_Z),
        ).toBeLessThan(0.0);
        expect(Cartesian3.dot(camera.up, Cartesian3.UNIT_Z)).toBeGreaterThan(
            0.0,
        );
    ...
    it("rotates with constrained axis", function () {
        ...
        expect(Cartesian3.dot(camera.up, axis)).toBeLessThan(
            CesiumMath.EPSILON2,
        );
        expect(camera.right).toEqualEpsilon(
            Cartesian3.cross(camera.direction, camera.up, new Cartesian3()),
