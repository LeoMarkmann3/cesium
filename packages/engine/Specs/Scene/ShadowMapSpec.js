...
describe(
    ...
    function () {
        ...
        const boxCutoutUrl =
            "./Data/Models/glTF-2.0/BoxCutout/glTF/BoxCutout.gltf";
        ...
        beforeAll(function () {
            ...
            const boxScale = 0.5;
            const boxScaleCartesian = new Cartesian3(
                boxScale,
                boxScale,
                boxScale,
            );
            ...
            primitiveFloorRTC = createPrimitiveRTC(
                floorTransform,
                2.0,
                Color.RED,
            );
        ...
        it("defaults to color texture if depth texture extension is not supported", function () {
                ...
                function (rgba) {
                    if (sceneWithWebgl1.context.depthTexture) {
                        if (depthFramebufferSupported(sceneWithWebgl1)) {
                            expect(
                                sceneWithWebgl1.shadowMap._usesDepthTexture,
                            ).toBe(true);
                            expect(
                                sceneWithWebgl1.shadowMap._shadowMapTexture
                                    .pixelFormat,
            ...
            sceneWithWebgl1.shadowMap =
                sceneWithWebgl1.shadowMap &&
                sceneWithWebgl1.shadowMap.destroy();
            ...
            renderAndCall(
                function (rgba) {
                    expect(sceneWithWebgl1.shadowMap._usesDepthTexture).toBe(
                        false,
                    );
                    expect(
