    ...
    describe("selectTilesForRendering", function () {
        ...
        it("skips loading levels when tiles are known to be available", function () {
            ...
            return process(quadtree, function () {
                ...
                expect(quadtree._tilesToRender).not.toContain(
                    lookAtTile.parent,
                );
                ...
                .then(function () {
                    ...
                    return process(quadtree, function () {
                        ...
                        const parentRendered =
                            quadtree._tilesToRender.indexOf(
                                lookAtTile.parent,
                            ) >= 0;
    ...
    describe(
        ...
        function () {
            ...
            it("shows the root tiles when they are ready and visible", function () {
                const tileProvider = createSpyTileProvider();
                tileProvider.getReady.and.returnValue(true);
                tileProvider.computeTileVisibility.and.returnValue(
                    Visibility.FULL,
                );
            ...
            it("tileLoadProgressEvent is raised when tile loaded and when new children discovered", function () {
                ...
                eventHelper.add(
                    quadtree.tileLoadProgressEvent,
                    progressEventSpy,
                );
                ...
                quadtree._levelZeroTiles[1].state =
            ...
            it("add and remove callbacks to tiles", function () {
                ...
                quadtree.forEachLoadedTile(function (tile) {
                    removedCallback =
                        removedCallback && tile.customData.size === 0;
                });
            ...
            it("updates heights", function () {
                ...
                const updatedPositionCarto = Cartographic.fromDegrees(
                    -72.0,
                    40.0,
                    100,
                );
                ...
                const updatedPosition =
                    Cartographic.toCartesian(updatedPositionCarto);
            ...
            it("renders tiles in approximate near-to-far order", function () {
                ...
                return pollToPromise(function () {
                    ...
                    const west = quadtree._levelZeroTiles.filter(
                        function (tile) {
                            return tile.x === 0;
                        },
                    )[0];
                    const east = quadtree._levelZeroTiles.filter(
                        function (tile) {
                            return tile.x === 1;
                        },
                    )[0];
                    expect(quadtree._tilesToRender[0]).toBe(
                        east.northwestChild,
                    );
                    expect(
                    ...
                    expect(quadtree._tilesToRender[3]).toBe(
                        east.southeastChild,
                    );
                    expect(quadtree._tilesToRender[4]).toBe(
                        west.northeastChild,
                    );
                    expect(
                    ...
                    expect(quadtree._tilesToRender[7]).toBe(
                        west.southwestChild,
                    );
                });
            });
