    ...
    function () {
        ...
        function allPrimitivesReady(points) {
            ...
            return pollToPromise(function () {
                ...
                const backgroundBillboard =
                    points._labelCollection._backgroundBillboardCollection.get(
                        0,
                    );
                return (
                    (!defined(backgroundBillboard) ||
                        backgroundBillboard.ready) &&
            ...
            return loadPoints(points)
                .then(function () {
                    ...
                    for (i = 0; i < features.length; ++i) {
                        ...
                        expect(feature.labelColor).toEqual(
                            new Color(1.0, 1.0, 0.0, 1.0),
                        );
                        ...
                        expect(feature.labelStyle).toEqual(
                        ...
                        expect(feature.backgroundPadding).toEqual(
                            new Cartesian2(10, 11),
                        );
                        ...
                        expect(feature.horizontalOrigin).toEqual(
                            HorizontalOrigin.CENTER,
                        );
                        expect(feature.verticalOrigin).toEqual(
                            VerticalOrigin.CENTER,
                        );
                        expect(feature.labelHorizontalOrigin).toEqual(
                            HorizontalOrigin.RIGHT,
                        );
                        expect(feature.labelVerticalOrigin).toEqual(
        ...
        it("renders multiple points and test style options witch can be evaluated to undefined", function () {
            ...
            for (let i = 0; i < testOptions.length; ++i) {
                cartoPositions.push(
                    Cartographic.fromDegrees(0.1 * i, 0.0, 10.0),
                );
            }
            ...
            for (
                ...
                styleOptions[cesium3DTileStyleOptionName] = {
                    evaluate: function (feature) {
                        if (
                            feature.getProperty("pointIndex") ===
                            testOptionIndex
                        ) {
                            return undefined;
                        }
                ...
                for (i = 0; i < features.length; ++i) {
                    ...
                    for (
                        ...
                        if (defined(expectedCesium3DTileFeaturePropertyValue)) {
                            expect(
                                feature[cesium3DTileFeaturePropertyName],
                            ).toBeDefined();
                            expect(
                                feature[cesium3DTileFeaturePropertyName],
                            ).toEqual(expectedCesium3DTileFeaturePropertyValue);
                        } else {
                            expect(
                                feature[cesium3DTileFeaturePropertyName],
                            ).toBeUndefined();
