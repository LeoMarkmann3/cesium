        ...
        describe("polylinePositions", function () {
            ...
            it("polylinePositions gets positions for polyline vector data", function () {
                ...
                return Cesium3DTilesTester.loadTileset(
                    ...
                    const feature =
                        tileset.root.children[0].content.getFeature(0);
        ...
        describe("metadata", function () {
            ...
            it("getPropertyInherited returns undefined for unknown property", function () {
                const feature = new Cesium3DTileFeature(
                    childContents["ll.b3dm"],
                    0,
                );
                expect(
                    feature.getPropertyInherited("unknown"),
                ).not.toBeDefined();
            });
            ...
            it("getPropertyInherited returns content property", function () {
                ...
                expect(feature.getPropertyInherited("triangleCount")).toBe(
                    15000,
                );
            });
            ...
            it("getPropertyInherited handles noData", function () {
                let feature = new Cesium3DTileFeature(
                    childContents["ll.b3dm"],
                    0,
                );
                expect(
            ...
            it("getPropertyInherited returns tileset property", function () {
                const feature = new Cesium3DTileFeature(parentContent, 0);
                expect(
                    feature.getPropertyInherited("centerCartographic"),
                ).toEqual(
                    new Cartesian3(
                        -1.3196816996258511,
                        0.6988767486400521,
        ...
        describe("implicit tiling metadata", function () {
            describe("subtree metadata", function () {
                ...
                it("getPropertyInherited returns tile property that is shared by subtree at root level", function () {
                    ...
                    expect(
                        feature.getPropertyInherited("Height"),
                    ).toBeInstanceOf(Number);
                    expect(feature.getPropertyInherited("Height")).not.toEqual(
                        1000,
                    );
                });
                ...
                it("getPropertyInherited returns tile property that is shared by subtree at child level", function () {
                    ...
                    const rootFeature = new Cesium3DTileFeature(
                        subtreeRootContent,
                        0,
                    );

                    const childHeight =
                        childFeature.getPropertyInherited("Height");
                    const rootHeight =
                        rootFeature.getPropertyInherited("Height");
            ...
            describe("implicit content metadata", function () {
                ...
                it("getPropertyInherited returns content property", function () {
                    ...
                    expect(rootFeature.getPropertyInherited("height")).toEqual(
                        10,
                    );
                ...
                it("getPropertyInherited returns content property by semantic for different contents", function () {
                    ...
                    expect(
                        secondChildFeature.getPropertyInherited(
                            "_BUILDING_HEIGHT",
                        ),
                    ).toEqual(40);
                });
                ...
                it("getPropertyInherited returns content property for different contents", function () {
                    ...
                    expect(childFeature.getPropertyInherited("height")).toEqual(
                        20,
                    );
                    expect(
                        secondChildFeature.getPropertyInherited("height"),
                    ).toEqual(40);
                    ...
                    expect(
                        secondChildFeature.getPropertyInherited("color"),
