...
describe(
    ...
    function () {
        ...
        it("creates an animation in 3d", function () {
            ...
            const endPosition = Cartesian3.negate(
                startPosition,
                new Cartesian3(),
            );
        ...
        it("creates animation to hit flyOverLongitude", function () {
            ...
            projection.ellipsoid.cartesianToCartographic(
                camera.position,
                position,
            );
        ...
        it("uses flyOverLongitudeWeight", function () {
            ...
            const overLonFlightSmallWeight = CameraFlightPath.createTween(
                scene,
                {
                    destination: endPosition,
                    duration: 1.0,
        ...
        it("animation with flyOverLongitude is smooth over two pi", function () {
            ...
            camera.position = Cartesian3.fromDegrees(
                startLonDegrees,
                45.0,
                1000.0,
            );
