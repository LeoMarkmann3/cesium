...
describe("Scene/CreditDisplay", function () {
    ...
    it("credits have unique ids", function () {
        const credit1 = new Credit(
            '<a href="http://cesiumjs.org/">credit1</a>',
        );
        const credit2 = new Credit(
            '<a href="http://cesiumjs.org/">credit2</a>',
        );
        expect(credit1.id).not.toEqual(credit2.id);

        const credit3 = new Credit(
            '<a href="http://cesiumjs.org/">credit1</a>',
        );
    ...
    function runTests() {
        ...
        it("credit display updates html when credits change", function () {
            ...
            expect(innerHTMLWithCredit1AndCredit2).not.toEqual(
                innerHTMLWithCredit1,
            );
            expect(innerHTMLWithCredit1AndCredit2).not.toEqual(
                innerHTMLWithCredit2,
            );
            ...
            expect(container.innerHTML).not.toEqual(
                innerHTMLWithCredit1AndCredit2,
            );
        ...
        it("credit display displays a static credit", function () {
            ...
            const creditContainer = container.childNodes[1];
            expect(creditContainer.childNodes.length).toEqual(3);
            expect(creditContainer.childNodes[0]).toEqual(
                defaultCredit.element,
            );
        ...
        it("displays credits in a lightbox", function () {
            ...
            expect(creditList.childNodes[0].childNodes[0]).toEqual(
                credit1.element,
            );
        ...
        it("displays static credits in a lightbox", function () {
            ...
            expect(creditList.childNodes[1].childNodes[0]).toEqual(
                credit2.element,
            );
        ...
        it("handles showOnScreen toggles at runtime", function () {
            ...
            expect(screenCreditContainer.childNodes[0]).toEqual(
                credit1.element,
            );
            expect(screenCreditContainer.childNodes[2]).toEqual(
                credit2.element,
            );
        ...
        it("works if Cesium credit removed", function () {
            ...
            creditDisplay.beginFrame();
            creditDisplay.endFrame();
            expect(creditDisplay._cesiumCreditContainer.childNodes.length).toBe(
                0,
            );
