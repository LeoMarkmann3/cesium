define(["dijit/dijit", "dojo"], function (dijit, dojo) {
    ...
    function newDatesSelected() {
        ...
        if (startDatePart && startTimePart) {
            startJulian = JulianDate.fromIso8601(
                `${startDatePart + startTimePart}Z`,
            ); // + 'Z' for UTC
        }
    ...
    dojo.ready(function () {
        ...
        dojo.connect(
            dijit.byId("startTimeSel"),
            "onChange",
            newStartTimeSelected,
        );
